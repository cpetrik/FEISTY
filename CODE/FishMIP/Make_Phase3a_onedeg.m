...
%     Spinup_fishingv2_gfdl_onedeg_ctrlclim_server()
    Spinup_fishingv3_gfdl_onedeg_ctrlclim_server()
end
...
%     PI_fishingv2_empHP_gfdl_mom6_cobalt2_onedeg_ctrlclim_server()
    PI_fishingv3_empHP_gfdl_mom6_cobalt2_onedeg_ctrlclim_server()
end
if hist_onedeg_obs 
...
%     Hist_fishingv2_empHP_gfdl_mom6_cobalt2_onedeg_obsclim_server()
    Hist_fishingv3_empHP_gfdl_mom6_cobalt2_onedeg_obsclim_server()
end
if hist_onedeg_ctrl 
...
%     Hist_fishingv2_empHP_gfdl_mom6_cobalt2_onedeg_ctrlclim_server()
    Hist_fishingv3_empHP_gfdl_mom6_cobalt2_onedeg_ctrlclim_server()
end
