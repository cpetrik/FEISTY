%%%% File naming system
function [fname,simname] = sub_fname_spin_gfdl_onedeg(param)
...
%outdir = ['/Volumes/petrik-lab/Feisty/MIP/NC/FishMIP/GFDL_mom6_cobalt2/',simname,'/OneDeg/'];
...
elseif (param.MFsel~=param.LPsel)
    ...
    fname = [outdir, 'Spinup_ctrlclim_', sel,'_fish_',tfish];  
end
