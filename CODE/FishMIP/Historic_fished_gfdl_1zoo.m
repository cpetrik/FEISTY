...
function Historic_fished_gfdl_1zoo()
...
make_parameters_1zoo() % make core parameters/constants
...
[fname,simname] = sub_fname_hist_1zoo(frate);
...
for YR = 1:YEARS % years
    ...
    for DAY = 1:DT:DAYS % days
        ...
        [Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,ENVR] = ...
            sub_futbio_1zoo(ID,DY,COBALT,ENVR,Sml_f,Sml_p,Sml_d,...
