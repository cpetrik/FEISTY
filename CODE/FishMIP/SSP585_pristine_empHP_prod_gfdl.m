%%%%!! RUN SSP 585 FOR ALL LOCATIONS 
% save production
function SSP585_pristine_empHP_prod_gfdl()
...
YEARS = length(2015:2100);
DAYS = 365;
MNTH = [31,28,31,30,31,30,31,31,30,31,30,31];

%! Create a directory for output
[fname,simname] = sub_fname_ssp585_gfdl(param);
...
%! Initialize
init_sim = simname;
load(['/Volumes/petrik-lab/Feisty/NC/FishMIP/GFDL_CMIP6/',init_sim '/Last_mo_hist_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
file_time  = [fname,'_empHP_prod_time.nc'];
...
ncidB  = netcdf.create(file_time,'NC_WRITE');
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/GFDL/ssp585/Data_gfdl_ssp585_daily_',ti,'.mat'],'ESM');
