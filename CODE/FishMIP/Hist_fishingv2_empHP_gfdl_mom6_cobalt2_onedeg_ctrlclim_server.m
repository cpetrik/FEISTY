...
function Hist_fishingv2_empHP_gfdl_mom6_cobalt2_onedeg_ctrlclim_server()

%%%%%%%%%%%%%%% Initialize Model Variables
%! Set fishing rate
load(['/Users/cpetrik/Dropbox/Princeton/FEISTY_other/fishing_ms_ideas/fishing_effort_impl/grid_mortality_guilds_v2/',...
    'gfdl-mom6-cobalt2_ctrlclim_onedeg_fmort_ID_annual_1841_1960_tempSc_v2.mat'],...
    'fmD','fmF','fmP');
