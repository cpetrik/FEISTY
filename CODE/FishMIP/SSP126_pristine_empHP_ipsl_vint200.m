...
function SSP126_pristine_empHP_ipsl_vint200()
...
%! Initialize
load(['/project/Feisty/NC/WG2300/',simname,'/IPSL/Last_mo_IPSL_historic_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/IPSL/ssp126/Data_ipsl_ssp126_daily_',ti,'.mat'],'ESM');
