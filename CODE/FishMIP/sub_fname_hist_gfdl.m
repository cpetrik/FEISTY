%%%% File naming system
function [fname,simname] = sub_fname_hist_gfdl(param)
...
if (frate==0)
    fname = ['/Volumes/petrik-lab/Feisty/NC/FishMIP/GFDL_CMIP6/',simname, '/Hist'];
elseif (param.Jsel~=0.1)
    fname = ['/Volumes/petrik-lab/Feisty/NC/FishMIP/GFDL_CMIP6/',simname, '/Hist_', sel,'_fish',tfish(2:end),'_Juve',tJ(2:end)];
elseif (param.MFsel~=param.LPsel)
    fname = ['/Volumes/petrik-lab/Feisty/NC/FishMIP/GFDL_CMIP6/',simname, '/Hist_fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/petrik-lab/Feisty/NC/FishMIP/GFDL_CMIP6/',simname, '/Hist_', sel,'_fish',tfish(2:end)];  
end
