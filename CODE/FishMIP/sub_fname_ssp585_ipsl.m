...
if (frate==0)
    fname = ['/Volumes/MIP/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP585'];
elseif (param.Jsel~=0.1)
    fname = ['/Volumes/MIP/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP585_', sel,'_fish',tfish(2:end),'_Juve',tJ(2:end)];
elseif (param.MFsel~=param.LPsel)
    fname = ['/Volumes/MIP/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP585_fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/MIP/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP585_', sel,'_fish',tfish(2:end)];  
end
