...
function SSP585_pristine_empHP_gfdl()
...
%! Initialize
init_sim = simname;
load(['/Volumes/FEISTY/NC/FishMIP/GFDL_CMIP6/',init_sim '/Last_mo_hist_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/FEISTY/Fish-MIP/CMIP6/GFDL/ssp585/Data_gfdl_ssp585_daily_',ti,'.mat'],'ESM');
