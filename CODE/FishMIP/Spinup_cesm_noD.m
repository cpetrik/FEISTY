...
[fname,simname] = sub_fname_spin_cesm_noD(frate);
...
%! Initialize
[Sml_f,Sml_p,Med_f,Med_p,Lrg_p] = sub_init_fish_noD(ID,DAYS);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+1849);
    load(['/Volumes/FEISTY/Fish-MIP/CESM/PreIndust/Data_cesm_pi_',ti,'.mat'],'CESM');
    %ZOOP OFF BY 1E3
    CESM.Zm = CESM.Zm * 1e3;
    CESM.Zl = CESM.Zl * 1e3;
