...
function SSP126_pristine_empHP_cesm_vint200_zmeso()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_ssp126_zmeso';
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/ssp126/Data_cesm_ssp126_daily_',ti,'_zmeso_bc.mat'],'ESM');
