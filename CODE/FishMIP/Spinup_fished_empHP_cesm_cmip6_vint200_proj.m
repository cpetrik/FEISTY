...
function Spinup_fished_empHP_cesm_cmip6_vint200_proj()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_spinup_Lfrac70';
...
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/Data_cesm_hist_daily_1949_Lfrac70.mat','ESM');
