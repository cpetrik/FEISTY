...
function SSP126_pristine_empHP_ukesm_vint200()
...
%! Initialize
load(['/project/Feisty/NC/WG2300/',simname,'/UKESM/Last_mo_UKESM_historic_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/ssp126/Data_ukesm_ssp126_daily_',ti,'.mat'],'ESM');
