...
function Historic_pristine_empHP_cesm_vint200_zmeso()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_historic_zmeso';
...
%! Initialize
%load(['/Volumes/petrik-lab/Feisty/NC/WG2300/',simname,'/CESM2-WACCM/Last_mo_CESM2-WACCM_spinup_zooc_pristine_',simname,'.mat']);
load(['/project/Feisty/NC/WG2300/',simname,'/CESM2-WACCM/Last_mo_CESM2-WACCM_spinup_zmeso_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
ncidB  = netcdf.create(file_bent,'NETCDF4');
% ncidMZ = netcdf.create(file_mzoo,'NETCDF4');
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/Data_cesm_hist_daily_',ti,'_zmeso_bc.mat'],'ESM');
