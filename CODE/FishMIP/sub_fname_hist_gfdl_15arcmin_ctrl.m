%%%% File naming system
function [fname,simname,outdir] = sub_fname_hist_gfdl_15arcmin_ctrl(param)
...
outdir = ['/Volumes/MIP/NC/FishMIP/GFDL_mom6_cobalt2/',simname,'/QuarterDeg/'];
...
elseif (param.MFsel~=param.LPsel)
    ...
    fname = [outdir, 'Hist_ctrlclim_', sel,'_fish',tfish(2:end)];
end
