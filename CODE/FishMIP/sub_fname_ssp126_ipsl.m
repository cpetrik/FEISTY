%%%% File naming system
function [fname,simname] = sub_fname_ssp126_ipsl(param)
...
if (frate==0)
    fname = ['/Volumes/FEISTY/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP126'];
elseif (param.Jsel~=0.1)
    fname = ['/Volumes/FEISTY/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP126_', sel,'_fish',tfish(2:end),'_Juve',tJ(2:end)];
elseif (param.MFsel~=param.LPsel)
    fname = ['/Volumes/FEISTY/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP126_fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/FEISTY/NC/FishMIP/IPSL_CMIP6/',simname, '/SSP126_', sel,'_fish',tfish(2:end)];  
end
