...
function SSP126_pristine_empHP_gfdl()
...
[fname,simname] = sub_fname_ssp126_gfdl(param);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/FEISTY/Fish-MIP/CMIP6/GFDL/ssp126/Data_gfdl_ssp126_daily_',ti,'.mat'],'ESM');
