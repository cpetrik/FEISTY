...
%! Initialize
init_sim = simname;
load(['/Volumes/MIP/NC/FishMIP/GFDL_CMIP6/',init_sim '/Last_mo_hist_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/MIP/Fish-MIP/CMIP6/GFDL/ssp126/Data_gfdl_ssp126_daily_',ti,'.mat'],'ESM');
