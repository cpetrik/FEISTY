%%%%!! RUN SSP 126 FOR ALL LOCATIONS
function SSP585_pristine_empHP_prod_ipsl()
...
[fname,simname] = sub_fname_ssp585_ipsl(param);
...
%! Initialize
init_sim = simname;
load(['/Volumes/petrik-lab/Feisty/NC/FishMIP/IPSL_CMIP6/',init_sim '/Last_mo_hist_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
file_bent  = [fname,'_empHP_prod_bent.nc'];
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/ssp585/Data_ipsl_ssp585_daily_',ti,'.mat'],'ESM');
