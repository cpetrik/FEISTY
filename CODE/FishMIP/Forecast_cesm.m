...
YEARS = length(2006:2100);
DAYS = 365;
MNTH = [31,28,31,30,31,30,31,31,30,31,30,31];

%! Create a directory for output
[fname,simname] = sub_fname_fore_cesm(frate);
...
%% ! Initialize
init_sim = simname;
load(['/Volumes/GFDL/NC/FishMIP/CESM1-BEC/',init_sim '/Last_mo_historic_pristine_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2005);
    load(['/Volumes/GFDL/Fish-MIP/CESM/RCP85/Data_cesm_rcp85_',ti,'.mat']);
    %ZOOP OFF BY 1E3
    CESM.Zm = CESM.Zm * 1e3;
    CESM.Zl = CESM.Zl * 1e3;
