...
function Historic_pristine_empHP_prod_ipsl()
...
[fname,simname] = sub_fname_hist_ipsl(param);
...
%! Initialize
init_sim = simname;
load(['/Volumes/petrik-lab/Feisty/NC/FishMIP/IPSL_CMIP6/',init_sim '/Last_mo_spinup_' init_sim '.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+1949)
    load(['/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/hist/Data_ipsl_hist_daily_',ti,'.mat'],'ESM');
