...
function Preindust_pristine_empHP_gfdl()
...
YEARS = length(1950:2100);
DAYS = 365;
MNTH = [31,28,31,30,31,30,31,31,30,31,30,31];

%! Create a directory for output
[fname,simname] = sub_fname_pi_gfdl(param);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+1949)
    load(['/Volumes/MIP/Fish-MIP/CMIP6/GFDL/preindust/Data_gfdl_pi_daily_',ti,'.mat'],'ESM');
