...
function SSP534_pristine_empHP_ipsl_vint200()
...
%! Initialize
%load(['/Volumes/petrik-lab/Feisty/NC/WG2300/',simname,'/IPSL/Last_mo_IPSL_ssp585_pristine_',simname,'.mat']);
load(['/project/Feisty/NC/WG2300/',simname,'/IPSL/Last_mo_IPSL_ssp585_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/IPSL/ssp534over/Data_ipsl_ssp534-over_daily_',ti,'.mat'],'ESM');
