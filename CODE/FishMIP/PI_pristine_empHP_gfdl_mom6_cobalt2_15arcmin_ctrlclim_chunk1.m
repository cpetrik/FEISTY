...
for c = 1:CYCLES
    ...
    file_sml_p = [fname,'_empHP_sml_p_cycle',num2str(c),'.nc'];
    file_sml_d = [fname,'_empHP_sml_d_cycle',num2str(c),'.nc'];
    file_med_f = [fname,'_empHP_med_f_cycle',num2str(c),'.nc'];
    file_med_p = [fname,'_empHP_med_p_cycle',num2str(c),'.nc'];
    file_med_d = [fname,'_empHP_med_d_cycle',num2str(c),'.nc'];
    file_lrg_p = [fname,'_empHP_lrg_p_cycle',num2str(c),'.nc'];
    file_lrg_d = [fname,'_empHP_lrg_d_cycle',num2str(c),'.nc'];
