%%%%!! RUN NPP CONTROL CASE FOR ALL LOCATIONS
% NPP-related variables are PreIndust, temperature is Historic & RCP 8.5
function NPP_cont_cesm()
...
[fname,simname] = sub_fname_npp_cesm(frate);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+1849);
    load(['/Volumes/GFDL/Fish-MIP/CESM/NPP_cont/Data_cesm_npp_cont_',ti,'.mat']);
    %ZOOP OFF BY 1E3
    CESM.Zm = CESM.Zm * 1e3;
    CESM.Zl = CESM.Zl * 1e3;
