...
function SSP534_pristine_empHP_cesm_vint200_zmeso()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_ssp534-over_zmeso';
...
load(['/project/Feisty/NC/WG2300/',simname,'/CESM2-WACCM/Last_mo_CESM2-WACCM_ssp585_zmeso_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/ssp534over/Data_cesm_ssp534-over_daily_',ti,'_zmeso_bc.mat'],'ESM');
