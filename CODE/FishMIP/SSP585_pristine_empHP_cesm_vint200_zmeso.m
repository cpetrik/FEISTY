...
function SSP585_pristine_empHP_cesm_vint200_zmeso()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_ssp585_zmeso';
...
%! Initialize
load(['/project/Feisty/NC/WG2300/',simname,'/CESM2-WACCM/Last_mo_CESM2-WACCM_historic_zmeso_pristine_',simname,'.mat']);
BENT.mass = BENT.bio;
...
for YR = 1:nYEARS % years
    ...
    ti = num2str(YEARS(YR));
    load(['/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/ssp585/Data_cesm_ssp585_daily_',ti,'_zmeso_bc.mat'],'ESM');
