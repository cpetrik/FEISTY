...
[fname,simname] = sub_fname_ssp126_ipsl(param);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2014)
    load(['/Volumes/FEISTY/Fish-MIP/CMIP6/IPSL/ssp126/Data_ipsl_ssp126_daily_',ti,'.mat'],'ESM');
