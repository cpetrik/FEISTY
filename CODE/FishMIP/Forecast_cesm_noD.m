...
[fname,simname] = sub_fname_fore_cesm_noD(frate);
...
%% ! Initialize
init_sim = simname;
load(['/Volumes/FEISTY/NC/FishMIP/CESM1-BEC/',init_sim '/Last_mo_historic_pristine_' init_sim '.mat']);
...
for YR = 1:YEARS % years
    ...
    ti = num2str(YR+2005);
    load(['/Volumes/FEISTY/Fish-MIP/CESM/RCP85/Data_cesm_rcp85_',ti,'.mat'],'CESM');
    %ZOOP OFF BY 1E3
    CESM.Zm = CESM.Zm * 1e3;
    CESM.Zl = CESM.Zl * 1e3;
