...
function Spinup_pristine_empHP_cesm_cmip6_vint200_proj_zmeso()
...
mod = 'CESM2-WACCM';
exper = 'CESM2-WACCM_spinup_zmeso';
...
%load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/Data_cesm_hist_daily_1850_zmeso_bc.mat','ESM');
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/Data_cesm_hist_daily_1850_zmeso_bc.mat','ESM');
