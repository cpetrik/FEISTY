...
function Spinup_pristine_empHP_cesm_cmip6_vint200_proj_zooc()
...
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/Data_cesm_hist_daily_1850_zooc.mat','ESM');
