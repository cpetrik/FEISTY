...
load([fpath 'Means_NPP_cont_' cfile '.mat'],'sf_meanP','sp_meanP',...
    'mf_meanP','mp_meanP',...
    'lp_meanP',...
    'sf_meanF','sp_meanF',...
    'mf_meanF','mp_meanF',...
...
text(2.6,1.75,'NPP control 2090-2100 vs 1860-1870 % change biomass','HorizontalAlign','center')
text(-2.75,1.25,'F')
...
text(-2.75,1.25,'All')
%stamp(cfile)
print('-dpng',[ppath 'NPP_cont_',harv,'_global_All_subplot_pdiffs.png'])
...
print('-dpng',[ppath 'NPP_cont_',harv,'_global_sizes_subplot_pdiffs.png'])
