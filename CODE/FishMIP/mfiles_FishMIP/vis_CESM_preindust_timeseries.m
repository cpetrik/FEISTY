...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Preindust_',harv,'_P_time.png'])
% 
% % Forage fishes
% figure(2)
% subplot(3,1,1)
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Preindust_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Preindust_',harv,'_D_time.png'])
% 
% % Benthic inverts
% figure(4)
% subplot(2,1,1)
...
% print('-dpng',[ppath 'Preindust_',harv,'_B_time.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Preindust_',harv,'_ts_all_sizes.png'])
...
title(['Preindustrial ' harv])
stamp(cfile)
print('-dpng',[ppath 'Preindust_',harv,'_ts_all_types.png'])
...
xlim([y(1) y(end)])
title(['Preindustrial ' harv ' biomass (g m^-^2)'])
ylabel('Forage fish')
...
stamp(cfile)
print('-dpng',[ppath 'Preindust_',harv,'_all_types_subplot.png'])
