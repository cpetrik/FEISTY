...
% Temperature control exper 1850-2100 initialized with spinup biomass
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Temp_cont_',harv,'_P_time.png'])
% 
% % Forage fishes
% figure(2)
% subplot(3,1,1)
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Temp_cont_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Temp_cont_',harv,'_D_time.png'])
% 
% % Benthic inverts
% figure(4)
% subplot(2,1,1)
...
% print('-dpng',[ppath 'Temp_cont_',harv,'_B_time.png'])
...
title(['Temperature control ' harv])
stamp(cfile)
print('-dpng',[ppath 'Temp_cont_',harv,'_ts_all_sizes.png'])
...
title(['Temperature control ' harv])
stamp(cfile)
print('-dpng',[ppath 'Temp_cont_',harv,'_ts_all_types.png'])
...
xlim([y(1) y(end)])
title(['Temperature control ' harv ' biomass (g m^-^2)'])
ylabel('Forage fish')
...
stamp(cfile)
print('-dpng',[ppath 'Temp_cont_',harv,'_all_types_subplot.png'])
