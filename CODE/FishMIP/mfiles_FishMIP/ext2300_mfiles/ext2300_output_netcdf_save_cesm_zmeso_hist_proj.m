...
fpath=['/project/Feisty/NC/WG2300/' cfile '/CESM2-WACCM/'];
harv = 'pristine';

%% Fish-MIP OUTPUTS =================================================

load([fpath 'FishMIP_outputs_monthly_CESM2-WACCM_historic_zmeso_pristine_' cfile '.mat'])
...
%% Grid
% load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/Data_grid_cesm2_cmip6_2300.mat','GRD');
...
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/gridspec_cesm2_cmip6_2300.mat');

[ni,nj] = size(LAT);

% load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/cesm2_hist_temp_btm_monthly_1850_2014.mat','time',...
%    'yr');
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/hist/cesm2_hist_temp_btm_monthly_1850_2014.mat','time',...
    'yr');
...
%pcolor(pb); shading flat; colorbar; clim([0 5])
...
%e.g.
%apecosm_cesm2-esm4_nobasd_picontrol_histsoc_default_tcb_global_monthly_2001_2010.nc

%% Setup netcdf path to store to
fname1 = 'feisty_cesm2-waccm_nobasd_historical_nat_default_zmeso_';
fname2 = '_global_monthly_1850_2014.nc';
...
netcdf.putAtt(ncidSB,varid,'mesozooplankton substitute','zmeso as diatom fraction of zooc, bias-corrected by obsGLMM');
...
netcdf.putAtt(ncidSD,varid,'mesozooplankton substitute','zmeso as diatom fraction of zooc, bias-corrected by obsGLMM');
...
netcdf.putAtt(ncidCB,varid,'mesozooplankton substitute','zmeso as diatom fraction of zooc, bias-corrected by obsGLMM');
...
netcdf.putAtt(ncid30,varid,'mesozooplankton substitute','zmeso as diatom fraction of zooc, bias-corrected by obsGLMM');
...
netcdf.putAtt(ncid90,varid,'contact','C. Petrik <cpetrik@ucsd.edu>');
netcdf.putAtt(ncid90,varid,'institution','UCSD');
netcdf.putAtt(ncid90,varid,'wet weight:C ratio','9:1');
netcdf.putAtt(ncid90,varid,'mesozooplankton substitute','zmeso as diatom fraction of zooc, bias-corrected by obsGLMM');
