...
load([fpath 'FishMIP_outputs_monthly_CESM2-WACCM_ssp126_zmeso_pristine_' cfile '.mat'])
...
load('/project/Feisty/Fish-MIP/CMIP6/CESM2-WACCM/ssp126/cesm2_ssp126_temp_btm_monthly_2015_2299.mat','time');
t_all = time;
...
fname1 = 'feisty_cesm2-waccm_nobasd_ssp126_nat_default_zmeso_';
fname2 = '_global_monthly_2015_2299.nc';
