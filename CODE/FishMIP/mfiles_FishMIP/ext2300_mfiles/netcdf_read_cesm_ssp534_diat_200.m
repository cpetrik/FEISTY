...
%% zoo zall
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_ssp534-over_phydiat_60arcmin_global_monthly_2040_2299.nc'])
...
%% 
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_ssp534-over_phydiat_60arcmin_global_monthly_2040_2299.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2_ssp534-over_diat_150_monthly_2040_2299.mat'],'diat_150',...
