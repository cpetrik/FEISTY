...
%% Meso Zoop zall
ncdisp([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_zmeso_60arcmin_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_zmeso_60arcmin_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%% Subset of thkcello
tcid = netcdf.open([fpath 'ukesm1-0-ll_r1i1p1f2_ssp126_thkcello_60arcmin_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
save([fpath 'ukesm_isimip_ssp126_zmeso_200_monthly_2015_2100.mat'],'zmeso_200',...
