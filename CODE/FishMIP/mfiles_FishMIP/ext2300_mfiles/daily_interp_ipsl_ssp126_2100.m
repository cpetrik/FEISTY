...
load([fpath 'ipsl_ssp126_temp_btm_monthly_2015_2100.mat'],'temp_btm');
load([fpath 'ipsl_ssp126_temp_200_monthly_2015_2100.mat'],'temp_200');
load([fpath 'ipsl_ssp126_zmeso_200_monthly_2015_2100.mat'],'zmeso_200');
load([fpath 'ipsl_ssp126_det_btm_monthly_2015_2100.mat']); %,'det'
...
for y = 1:nyrs
    ...
    % save
    save([fpath 'Data_ipsl_ssp126_daily_',num2str(ytime),'.mat'], 'ESM');
...
ssp126_Tb1 = mean(Tb);
ssp126_Zm1 = mean(Zm);
ssp126_Det1 = mean(Det);

%%
figure
subplot(2,2,1)
plot(yr,ssp126_Tp1,'r')

subplot(2,2,2)
plot(yr,ssp126_Tb1,'b')

subplot(2,2,3)
plot(yr,ssp126_Zm1,'color',[0.75 0 0.5])

subplot(2,2,4)
plot(yr,ssp126_Det1,'color',[0 0.5 0.75])

%% save means
ssp126_yr1 = yr;
save([fpath 'Means_ipsl_ssp126_monthly_2015_2100.mat'], 'ssp126_Tp1','ssp126_Tb1',...
    'ssp126_Zm1','ssp126_Det1','ssp126_yr1');
