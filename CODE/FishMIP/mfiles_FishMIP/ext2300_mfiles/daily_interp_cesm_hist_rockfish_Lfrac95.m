...
zmeso_150 = (Lfrac .* double(zooc_150)) + (0.95 * (1-Lfrac) .* double(zooc_150));

save([fpath 'cesm2_hist_zmeso_150_Lfrac95_monthly_1850_2014.mat'],'zmeso_150',...
...
for y = 100 %:nyrs
    ...
    % save
    save([fpath 'Data_cesm_hist_daily_',num2str(ytime),'_Lfrac95.mat'], 'ESM');
