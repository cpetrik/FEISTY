...
load([fpath 'ipsl_hist_temp_btm_monthly_1850_2014.mat'],'temp_btm');
load([fpath 'ipsl_hist_temp_200_monthly_1850_2014.mat'],'temp_200');
load([fpath 'ipsl_hist_zmeso_200_monthly_1850_2014.mat'],'zmeso_200','units_vint');
load([fpath 'ipsl_hist_det_monthly_1850_2014.mat']); %,'det'
...
for y = 1:nyrs
    ...
    % save
    save([fpath 'Data_ipsl_hist_daily_',num2str(ytime),'.mat'], 'ESM');
...
%% save means
hist_yr = yr;
save([fpath 'Means_ipsl_hist_monthly.mat'], 'hist_Tp','hist_Tb',...
