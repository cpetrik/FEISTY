...
load([fpath 'FishMIP_outputs_monthly_UKESM_ssp126_pristine_' cfile '.mat'])
...
load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/ssp126/ukesm_ssp126_temp_btm_monthly_2015_2300.mat',...
    'time','yr');
t_all = time;
...
fname1 = 'feisty_ukesm1-0-ll_nobasd_ssp126_nat_default_';
fname2 = '_global_monthly_2015_2300.nc';
