...
wid = find(ssp534_dep >0);

[ni,nj] = size(ssp534_dep);
...
title(['CESM Tbtm - North Sea ' num2str(round(ssp534_dep(nid))) 'm'])
legend('585','534')
...
title(['CESM Tbtm - E Bering Sea ' num2str(round(ssp534_dep(eid))) 'm'])
...
title(['CESM Tbtm - K2 ' num2str(round(ssp534_dep(kid))) 'm'])
...
title(['CESM Tbtm - BATS ' num2str(round(ssp534_dep(bid))) 'm'])

print('-dpng',[pp 'CESM2-WACCM_bottom_temp_locs.png'])
...
title(['CESM Tbtm - Greenland Sea ' num2str(round(ssp534_dep(gid))) 'm'])
legend('585','534')
legend('location','northwest')
...
title(['CESM Tbtm - Peru Upwelling ' num2str(round(ssp534_dep(uid))) 'm'])
...
title(['CESM Tbtm - S1 ' num2str(round(ssp534_dep(sid))) 'm'])
...
title(['CESM Tbtm - HOT ' num2str(round(ssp534_dep(hid))) 'm'])

print('-dpng',[pp 'CESM2-WACCM_bottom_temp_locs2.png'])
