...
%% temp btm
ncdisp([fpath 'ukesm1-0-ll_r4i1p1f2_ssp126_tob_60arcmin_global_monthly_2015_2300.nc'])
...
%% 
ncid = netcdf.open([fpath 'ukesm1-0-ll_r4i1p1f2_ssp126_tob_60arcmin_global_monthly_2015_2300.nc'],'NC_NOWRITE');
...
save([fpath 'ukesm_ssp126_temp_btm_monthly_2015_2300.mat'],'temp_btm','yr',...
