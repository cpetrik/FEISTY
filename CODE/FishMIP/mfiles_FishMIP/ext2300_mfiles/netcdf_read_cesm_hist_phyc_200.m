...
%% zoo zall
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_historical_phyc_60arcmin_global_monthly_1850_2014.nc'])
...
%% 
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_historical_phyc_60arcmin_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2_hist_phyc_150_monthly_1850_2014.mat'],'phyc_150',...
