...
load([fpath 'cesm2_ssp585_temp_btm_monthly_2015_2299.mat'],'time','lat','lon');
load([fpath 'cesm2_ssp585_zooc_150_monthly_2015_2299.mat'],'units_vint');
load([fpath 'cesm2_ssp585_zmeso150_biascorr_monthly_2015_2299.mat'],...
    'zmeso_corr');

time_units = 'months since 1601-1-1';

%% Setup netcdf path to store to
fname1 = 'cesm2-waccm_r1i1p1f1_ssp585_biascorr_zmeso_60arcmin_global_monthly_2015_2299.nc';
