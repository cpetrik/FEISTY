...
load([fpath 'FishMIP_outputs_monthly_IPSL_ssp585_pristine_' cfile '.mat'])
...
load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/ssp585/ipsl_ssp585_time_monthly_2015_2300.mat',...
    'yr','time');
t_all = time;
...
fname1 = 'feisty_ipsl-cm6a-lr_nobasd_ssp585_nat_default_';
