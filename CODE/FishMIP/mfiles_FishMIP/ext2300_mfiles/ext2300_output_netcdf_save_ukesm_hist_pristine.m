...
load([fpath 'FishMIP_outputs_monthly_UKESM_historic_pristine_' cfile '.mat'])
...
%% Grid
load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/Data_grid_ukesm_cmip6_2300.mat','GRD');
load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/gridspec_ukesm_cmip6_2300.mat');

[ni,nj] = size(LAT);

load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/hist/ukesm_hist_temp_btm_monthly_1850_2014.mat','time',...
    'yr');
...
%e.g.
%apecosm_ukesm-esm4_nobasd_picontrol_histsoc_default_tcb_global_monthly_2001_2010.nc

%% Setup netcdf path to store to
fname1 = 'feisty_ukesm1-0-ll_nobasd_historical_nat_default_';
