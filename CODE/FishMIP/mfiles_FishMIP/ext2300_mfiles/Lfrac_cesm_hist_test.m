...
zmeso_150_v2 = (Lfrac .* double(zooc_150)) + (0.25 * (1-Lfrac) .* double(zooc_150));

zmeso_150_v3 = (Lfrac .* double(zooc_150)) + (0.5 * (1-Lfrac) .* double(zooc_150));
...
%% save means
hist_yr = yr;
save([fpath 'Lfrac_zoo_test_cesm2_hist_monthly_1850.mat'],...
...
print('-dpng',[ppath 'Map_CESM2-WACCM_1850_Lfrac_zoop_test.png'])
...
title('Mesozoo')
legend('UKESM','IPSL','CESM0','CESM25','CESM50')
legend('location','northwest')
print('-dpng',[ppath 'ts_ESMs_hist_Lfrac_zoop_test.png'])
