...
% Meso Zoop zall
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_zmeso_60arcmin_global_monthly_2101_2300.nc'])
...
%
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_zmeso_60arcmin_global_monthly_2101_2300.nc'],'NC_NOWRITE');
...
save([fpath 'ipsl_ssp126_zmeso_200_monthly_2101_2300.mat'],'zmeso_200','yr',...
