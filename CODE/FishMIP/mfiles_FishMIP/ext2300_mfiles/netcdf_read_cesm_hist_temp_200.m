...
%% temp zall
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_historical_thetao_60arcmin_global_monthly_1850_2014.nc'])
...
%Size:       320x384x60x1980
%Dimensions: i,j,lev,time
%time units = 'months since 1601-1-1 00:00:00'

%% 
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_historical_thetao_60arcmin_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2_hist_temp_150_monthly_1850_2014.mat'],'temp_150',...
