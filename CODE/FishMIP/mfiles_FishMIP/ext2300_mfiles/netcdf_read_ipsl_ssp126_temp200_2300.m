...
% Temp zall
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_thetao_60arcmin_global_monthly_2101_2300.nc'])
...
% 
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_thetao_60arcmin_global_monthly_2101_2300.nc'],'NC_NOWRITE');
...
% Subset of thkcello
tcid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_thkcello_60arcmin_global_monthly_2101_2300.nc'],'NC_NOWRITE');
...
save([fpath 'ipsl_ssp126_temp_200_monthly_2101_2300.mat'],'temp_200','yr',...
