...
fpath=['/project/Feisty/NC/WG2300/' cfile '/UKESM/'];
harv = 'pristine';
...
load('/project/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/gridspec_ukesm_cmip6_2300.mat');

[ni,nj] = size(LAT);

load('/project/Feisty/Fish-MIP/CMIP6/UKESM1-0-LL/ssp534-over/ukesm_ssp534over_temp_btm_monthly_2015_2300.mat',...
    'yr','time');
t_all = time;
...
fname1 = 'feisty_ukesm1-0-ll_nobasd_ssp534-over_nat_default_';
