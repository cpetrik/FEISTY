...
%% zoo zall
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_historical_phydiat_60arcmin_global_monthly_1850_2014.nc'])
...
%% 
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_historical_phydiat_60arcmin_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2_hist_diat_150_monthly_1850_2014.mat'],'diat_150',...
