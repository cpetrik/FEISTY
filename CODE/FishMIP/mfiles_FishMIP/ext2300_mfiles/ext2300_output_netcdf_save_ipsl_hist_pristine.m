...
load([fpath 'FishMIP_outputs_monthly_IPSL_historic_pristine_' cfile '.mat'])
...
load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/gridspec_ipsl_cmip6_2300.mat');

[ni,nj] = size(LAT);

load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/hist/ipsl_hist_temp_btm_monthly_1950_2014.mat','time',...
    'yr');
...
fname1 = 'feisty_ipsl-cm6a-lr_nobasd_historical_nat_default_';
