...
load([fpath 'ipsl_ssp585_temp_200_monthly_2015_2100.mat'],'temp_200');
load([fpath 'ipsl_ssp585_zmeso_200_monthly_2015_2100.mat'],'zmeso_200');
load([fpath 'ipsl_ssp585_det_btm_monthly_2015_2100.mat']); %,'det'
...
% load('/project/Feisty/Fish-MIP/CMIP6/IPSL/Data_grid_ipsl.mat','GRD');
% WID = GRD.ID;
% NID = GRD.N;
...
for y = 1:nyrs
    ...
    % save
    save([fpath 'Data_ipsl_ssp585_daily_',num2str(ytime),'.mat'], 'ESM');
...
% %% save means
% ssp585_yr1 = yr;
% save([fpath 'Means_ipsl_ssp585_monthly_2015_2100.mat'], 'ssp585_Tp1','ssp585_Tb1',...
