...
% Temp zall
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_expc-bot_60arcmin_global_monthly_2101_2300.nc'])
...
% 
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_expc-bot_60arcmin_global_monthly_2101_2300.nc'],'NC_NOWRITE');
...
det = double(expc);
clear expc
test2 = squeeze(det(:,:,50))*12.01*9*60*60*24;
...
%%
save([fpath 'ipsl_ssp585_det_monthly_2101_2300.mat'],'det','yr',...
