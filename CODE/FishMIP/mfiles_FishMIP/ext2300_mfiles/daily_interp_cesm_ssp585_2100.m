...
load([fpath 'cesm_ssp585_temp_btm_monthly_2015_2100.mat'],'temp_btm');
load([fpath 'cesm_ssp585_temp_200_monthly_2015_2100.mat'],'temp_200');
load([fpath 'cesm_ssp585_zmeso_200_monthly_2015_2100.mat'],'zmeso_200');
load([fpath 'cesm_ssp585_det_btm_monthly_2015_2100.mat']); %,'det'

load('/Volumes/petrik-lab/Feisty/Fish-MIP/CMIP6/IPSL/gridspec_cesm_cmip6.mat','deptho')
...
save([fpath 'cesm_ssp585_zmeso_150_monthly_1850_2014.mat'],'zmeso_150',...
...
ssp585_Tb1 = mean(Tb);
ssp585_Zm1 = mean(Zm);
ssp585_Det1 = mean(Det);

%%
figure
subplot(2,2,1)
plot(yr,ssp585_Tp1,'r')

subplot(2,2,2)
plot(yr,ssp585_Tb1,'b')

subplot(2,2,3)
plot(yr,ssp585_Zm1,'color',[0.75 0 0.5])

subplot(2,2,4)
plot(yr,ssp585_Det1,'color',[0 0.5 0.75])

%% save means
ssp585_yr1 = yr;
save([fpath 'Means_cesm_ssp585_monthly_2015_2100.mat'], 'ssp585_Tp1','ssp585_Tb1',...
    'ssp585_Zm1','ssp585_Det1','ssp585_yr1');
