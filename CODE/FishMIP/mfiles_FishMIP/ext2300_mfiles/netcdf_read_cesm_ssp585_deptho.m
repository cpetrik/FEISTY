...
%% deptho
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_ssp585_deptho_60arcmin_global_fx.nc'])
...
%% 
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_ssp585_deptho_60arcmin_global_fx.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2-waccm_r1i1p1f1_ssp585_deptho_60arcmin_global_fx.mat']);
