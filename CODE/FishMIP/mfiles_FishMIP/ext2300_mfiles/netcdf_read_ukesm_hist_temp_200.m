...
%% Temp zall
ncdisp([fpath 'ukesm1-0-ll_r4i1p1f2_historical_thetao_60arcmin_global_monthly_1850_2014.nc'])
...
%%
ncid = netcdf.open([fpath 'ukesm1-0-ll_r4i1p1f2_historical_thetao_60arcmin_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
save([fpath 'ukesm_hist_temp_200_monthly_1850_2014.mat'],'temp_200',...
