...
%% Hist
load([fpath 'Means_CESM2-WACCM_historic_zooc_pristine_' cfile '.mat'],...
    'mo',...
...
%% SSP 126
load([fpath 'Means_CESM2-WACCM_ssp126_zooc_pristine_' cfile '.mat'],...
    'mo',...
    'sf_tmean','sp_tmean','sd_tmean',...
    'mf_tmean','mp_tmean','md_tmean',...
    'lp_tmean','ld_tmean','b_tmean');
...
%% SSP 585
load([fpath 'Means_CESM2-WACCM_ssp585_zooc_pristine_' cfile '.mat'],...
    'mo',...
    'sf_tmean','sp_tmean','sd_tmean',...
    'mf_tmean','mp_tmean','md_tmean',...
    'lp_tmean','ld_tmean','b_tmean');
...
%% SSP 534
load([fpath 'Means_CESM2-WACCM_ssp534_zooc_pristine_' cfile '.mat'],...
    'mo',...
    'sf_tmean','sp_tmean','sd_tmean',...
    'mf_tmean','mp_tmean','md_tmean',...
    'lp_tmean','ld_tmean','b_tmean');
...
print('-dpng',[ppath 'CESM2-WACCM_zooc_global_time_means_all_scenarios.png'])
...
ylim([-1.5 0.1])
title('CESM All fishes')
print('-dpng',[ppath 'CESM2-WACCM_zooc_global_time_diffs_all_scenarios.png'])
