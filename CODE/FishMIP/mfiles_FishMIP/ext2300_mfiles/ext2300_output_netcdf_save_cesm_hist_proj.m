...
load([fpath 'FishMIP_outputs_monthly_CESM2-WACCM_historic_zooc_pristine_' cfile '.mat'])
...
fname1 = 'feisty_cesm2-waccm_nobasd_historical_nat_default_zooc_';
...
netcdf.putAtt(ncidSB,varid,'mesozooplankton substitute','zooc');
...
netcdf.putAtt(ncidSD,varid,'mesozooplankton substitute','zooc');
...
netcdf.putAtt(ncidCB,varid,'mesozooplankton substitute','zooc');
...
netcdf.putAtt(ncid30,varid,'mesozooplankton substitute','zooc');
...
netcdf.putAtt(ncid90,varid,'mesozooplankton substitute','zooc');
