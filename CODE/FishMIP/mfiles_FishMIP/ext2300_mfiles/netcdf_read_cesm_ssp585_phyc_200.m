...
%% phyc zall
ncdisp([fpath 'cesm2-waccm_r1i1p1f1_ssp585_phyc_60arcmin_global_monthly_2015_2299.nc'])
...
%%
ncid = netcdf.open([fpath 'cesm2-waccm_r1i1p1f1_ssp585_phyc_60arcmin_global_monthly_2015_2299.nc'],'NC_NOWRITE');
...
save([fpath 'cesm2_ssp585_phyc_150_monthly_2015_2299.mat'],'phyc_150',...
