...
load([fpath 'ukesm_ssp126_zmeso_200_monthly_2015_2150.mat']);
...
for y = 1:nyrs
    ...
    % save
    save([fpath 'Data_ukesm_ssp126_daily_',num2str(ytime),'.mat'], 'ESM');
...
%% save means
ssp126_yr1 = yr;
save([fpath 'Means_ukesm_ssp126_monthly_2015_2150.mat'], 'ssp126_Tp1','ssp126_Tb1',...
