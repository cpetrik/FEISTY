...
zmeso_150 = (Lfrac .* double(zooc_150)) + (0.500 * (1-Lfrac) .* double(zooc_150));

save([fpath 'cesm2_hist_zmeso_150_Lfrac50_monthly_1850_2014.mat'],'zmeso_150',...
...
for y = 1%:nyrs
    ...
    % save
    save([fpath 'Data_cesm_hist_daily_',num2str(ytime),'_Lfrac50.mat'], 'ESM');
