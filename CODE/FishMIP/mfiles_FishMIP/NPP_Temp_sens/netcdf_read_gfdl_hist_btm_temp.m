% Read Fish-MIP GFDL Historic netcdfs
...
ncid = netcdf.open([fpath 'gfdl-esm2m_hist_to_zb_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'gfdl-esm2m_hist_tbtm_monthly_',num2str(tstart(1)),'-',...
    num2str(tend(end)),'.mat'],'tbtm','mod_time');
save([cpath 'gfdl-esm2m_hist_tbtm_monthly_',num2str(tstart(1)),'-',...
    num2str(tend(end)),'.mat'],'tbtm','mod_time');
