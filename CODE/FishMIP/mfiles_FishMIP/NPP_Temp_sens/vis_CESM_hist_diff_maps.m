...
text(2.6,1.75,'Historic 1851-1900 log_1_0 mean biomass (g m^-^2)','HorizontalAlign','center')
text(-2.75,1.25,'F')
...
text(-2.75,1.25,'All')
stamp(cfile)
print('-dpng',[ppath 'Historic_',harv,'_global_All_subplot_1800s.png'])
...
set(gcf,'renderer','painters')
%title('log_1_0 mean All F (g m^-^2)')
text(2.6,1.75,'Historic 1951-2000 log_1_0 mean biomass (g m^-^2)','HorizontalAlign','center')
text(-2.75,1.25,'F')
...
text(-2.75,1.25,'All')
stamp(cfile)
print('-dpng',[ppath 'Historic_',harv,'_global_All_subplot_1900s.png'])
...
% stamp(cfile)
% print('-dpng',[ppath 'Historic_',harv,'_CC_ratios_subplot.png'])
% 
