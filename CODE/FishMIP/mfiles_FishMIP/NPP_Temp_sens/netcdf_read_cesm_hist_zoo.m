...
ncid = netcdf.open([fpath 'cesm_hist_zoo_zint_monthly_',num2str(tstart(t)),'-',...
...
% save([fpath 'cesm_hist_zoo_zint_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_hist_zoo_zint_monthly_',num2str(tstart(1)),'-',...
