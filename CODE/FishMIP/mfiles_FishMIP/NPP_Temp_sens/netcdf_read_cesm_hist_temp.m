...
ncid = netcdf.open([fpath 'cesm_hist_to_zall_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_hist_tp_100_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_hist_tp_100_monthly_',num2str(tstart(1)),'-',...
