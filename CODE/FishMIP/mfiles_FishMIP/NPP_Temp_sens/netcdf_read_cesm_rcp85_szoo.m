...
ncid = netcdf.open([fpath 'cesm_rcp85_szoo_zall_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_rcp85_szoo_100_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_rcp85_szoo_100_monthly_',num2str(tstart(1)),'-',...
