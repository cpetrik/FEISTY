...
%% one file
ncdisp([fpath 'gfdl-mom6-cobalt2_obsclim_thetao_onedeg_global_monthly_1961_2010.nc'])
...
tcid = netcdf.open([fpath 'gfdl-mom6-cobalt2_obsclim_thkcello_onedeg_global_fixed.nc'],'NC_NOWRITE');
...
%% all but temp
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_obsclim_thetao_onedeg_global_monthly_1961_2010.nc'],'NC_NOWRITE');
...
save([fpath 'gfdl-mom6-cobalt2_obsclim_temp100_onedeg_global_monthly_1961_2010.mat'],...
