...
% mtb = nanmean(tob,3);
% save([tpath 'gfdl-mom6-cobalt2_ctrlclim_mtemp_15arcmin_global_1961_2010.mat'],...
%     'mtp','mtb');

%%
load([tpath 'gfdl-mom6-cobalt2_ctrlclim_mtemp_15arcmin_global_1961_2010.mat'])
vmtp = mtp(WID);
vmtb = mtb(WID);
...
save([tpath 'gfdl-mom6-cobalt2_ctrlclim_15arcmin_fmort_ID_annual_1961_2010_tempSc.mat'],'year','WID',...
    'fmD','fmF','fmP');
save([fpath 'gfdl-mom6-cobalt2_ctrlclim_15arcmin_fmort_ID_annual_1961_2010_tempSc.mat'],'year','WID',...
    'fmD','fmF','fmP');
save([spath 'gfdl-mom6-cobalt2_ctrlclim_15arcmin_fmort_ID_annual_1961_2010_tempSc.mat'],'year','WID',...
    'fmD','fmF','fmP');
