...
%% zmeso
ncdisp([fpath 'gfdl-mom6-cobalt2_obsclim_zmeso_onedeg_global_monthly_1961_2010.nc'])
...
%% all but zmeso
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_obsclim_zmeso_onedeg_global_monthly_1961_2010.nc'],'NC_NOWRITE');
