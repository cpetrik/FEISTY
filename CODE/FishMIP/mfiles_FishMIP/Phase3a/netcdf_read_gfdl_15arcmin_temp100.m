...
tcid = netcdf.open([fpath 'gfdl-mom6-cobalt2_ctrlclim_thkcello_15arcmin_global_fixed.nc'],'NC_NOWRITE');
...
%% all but temp
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_ctrlclim_thetao_15arcmin_global_monthly_1961_2010.nc'],'NC_NOWRITE');
...
save([fpath 'QuarterDeg/gfdl-mom6-cobalt2_ctrlclim_temp100_15arcmin_global_monthly_1961_2010.mat'],...
