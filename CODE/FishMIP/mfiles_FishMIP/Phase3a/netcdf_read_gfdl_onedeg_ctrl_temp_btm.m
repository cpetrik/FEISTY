...
%% one file
ncdisp([fpath 'gfdl-mom6-cobalt2_ctrlclim_tob_onedeg_global_monthly_1961_2010.nc'])
...
%%
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_ctrlclim_tob_onedeg_global_monthly_1961_2010.nc'],'NC_NOWRITE');
...
%%
save([fpath 'gfdl-mom6-cobalt2_ctrlclim_tob_onedeg_global_monthly_1961_2010.mat'],...
