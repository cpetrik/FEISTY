...
time_units = 'days since 1841-1-1 00:00:00'; %pi_units;
time_axis = 'T';
calendar = '365_day';
...
% MP catch
ncid = netcdf.open([fpath 'PI_ctrlclim_All_fishobs_v3.2_empHP_catch_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LP catch
ncid = netcdf.open([fpath 'PI_ctrlclim_All_fishobs_v3.2_empHP_catch_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MD catch
ncid = netcdf.open([fpath 'PI_ctrlclim_All_fishobs_v3.2_empHP_catch_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LD catch
ncid = netcdf.open([fpath 'PI_ctrlclim_All_fishobs_v3.2_empHP_catch_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MF catch
ncid = netcdf.open([fpath 'PI_ctrlclim_All_fishobs_v3.2_empHP_catch_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%e.g.
%boats_gfdl-mom6_cobalt2_obsclim_histsoc_default_tcb_global_monthly_1840_2010.nc
