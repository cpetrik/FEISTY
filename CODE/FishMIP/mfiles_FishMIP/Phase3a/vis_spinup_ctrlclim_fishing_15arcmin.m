...
harv = 'All_fishobs_v3.2_';
mod = [harv 'ctrlclim_15arcmin_'];
...
load([fpath 'Means_Spinup_ctrlclim_',harv, cfile '.mat']);
...
title('Spinup')
stamp(mod)
print('-dpng',[ppath 'Spinup_empHP_',mod,'all_sizes.png'])
...
title('Spinup')
stamp(mod)
print('-dpng',[ppath 'Spinup_empHP_',mod,'all_types.png'])
...
stamp(mod)
print('-dpng',[ppath 'Spinup_empHP_',mod,'global_BENT.png'])
...
stamp(mod)
print('-dpng',[ppath 'Spinup_empHP_',mod,'global_All_subplot.png'])
...
stamp(mod)
print('-dpng',[ppath 'Spinup_empHP_',mod,'global_ratios_subplot.png'])
