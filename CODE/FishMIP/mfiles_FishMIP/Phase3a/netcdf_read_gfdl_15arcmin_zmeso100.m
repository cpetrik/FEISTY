...
%% all but zmeso
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_ctrlclim_zmeso_15arcmin_global_monthly_1961_2010.nc'],'NC_NOWRITE');
...
%%
save([fpath 'QuarterDeg/gfdl-mom6-cobalt2_ctrlclim_zmeso100_15arcmin_global_monthly_1961_2010.mat'],...
