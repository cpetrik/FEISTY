...
time_units = 'days since 1831-1-1 00:00:00'; %spin_units;
time_axis = 'T';
calendar = '365_day';
...
MP.bio = biomass(:,(nt-120+1):nt);
MP.yield = yield(:,(nt-120+1):nt);
clear yield
clear biomass
...
LP.bio = biomass(:,(nt-120+1):nt);
LP.yield = yield(:,(nt-120+1):nt);
clear yield
clear biomass
...
MD.bio = biomass(:,(nt-120+1):nt);
MD.yield = yield(:,(nt-120+1):nt);
clear yield
clear biomass
...
LD.bio = biomass(:,(nt-120+1):nt);
LD.yield = yield(:,(nt-120+1):nt);
clear yield
clear biomass
...
MF.bio = biomass(:,(nt-120+1):nt);
MF.yield = yield(:,(nt-120+1):nt);
clear yield
clear biomass
...
fname1 = 'feisty_gfdl-mom6-cobalt2_histsoc_1955-riverine-input_';
