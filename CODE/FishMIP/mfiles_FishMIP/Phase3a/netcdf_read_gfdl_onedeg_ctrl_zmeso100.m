...
%% zmeso
ncdisp([fpath 'gfdl-mom6-cobalt2_ctrlclim_zmeso_onedeg_global_monthly_1961_2010.nc'])
...
%% all but zmeso
ncid = netcdf.open([fpath 'gfdl-mom6-cobalt2_ctrlclim_zmeso_onedeg_global_monthly_1961_2010.nc'],'NC_NOWRITE');
...
%%
save([fpath 'gfdl-mom6-cobalt2_ctrlclim_zmeso100_onedeg_global_monthly_1961_2010.mat'],...
