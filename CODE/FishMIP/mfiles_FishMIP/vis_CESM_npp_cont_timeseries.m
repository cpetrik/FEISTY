...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'NPP_cont_',harv,'_P_time.png'])
% 
% % Forage fishes
% figure(2)
% subplot(3,1,1)
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'NPP_cont_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'NPP_cont_',harv,'_D_time.png'])
% 
% % Benthic inverts
% figure(4)
% subplot(2,1,1)
...
% print('-dpng',[ppath 'NPP_cont_',harv,'_B_time.png'])
...
xlim([y(1) y(end)])
title(['NPP control ' harv ' biomass (g m^-^2)'])
ylabel('Forage fish')
...
stamp(cfile)
print('-dpng',[ppath 'NPP_cont_',harv,'_all_types_subplot.png'])
