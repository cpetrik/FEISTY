...
%% chl
ncdisp([fpath 'gfdl-esm4_r1i1p1f1_historical_zmicro_onedeg_global_monthly_1850_2014.nc'])
...
%%
ncid = netcdf.open([fpath 'gfdl-esm4_r1i1p1f1_historical_zmicro_onedeg_global_monthly_1850_2014.nc'],'NC_NOWRITE');
...
%%
save([fpath 'gfdl_hist_zmicro100_monthly_1950_2014.mat'],'zmicro_100','time',...
