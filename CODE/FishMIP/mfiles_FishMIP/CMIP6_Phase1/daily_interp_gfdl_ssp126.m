...
test1 = squeeze(double(temp_100(:,:,50)));
test2 = squeeze(double(temp_btm(:,:,50)));
test3 = squeeze(double(zmeso_100(:,:,50)));
test4 = squeeze(double(det_btm(:,:,50)));
