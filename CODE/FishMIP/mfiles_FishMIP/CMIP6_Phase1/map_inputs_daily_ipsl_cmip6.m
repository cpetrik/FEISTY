...
cpath = '/Volumes/FEISTY/Fish-MIP/CMIP6/IPSL/preindust/';
...
load([cpath 'Data_ipsl_spinup_daily_1949.mat'])
...
title('IPSL Det')
print('-dpng',[ppath 'Map_IPSL_Pre_1949_from_daily_interp_forcings.png'])
