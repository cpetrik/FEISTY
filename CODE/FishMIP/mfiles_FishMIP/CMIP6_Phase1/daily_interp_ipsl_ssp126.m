...
test1 = squeeze(double(temp_100(:,:,300)));
test2 = squeeze(double(temp_btm(:,:,300)));
test3 = squeeze(double(zmeso_100(:,:,300)));
test4 = squeeze(double(det_btm(:,:,300)));
...
for y = 1:nyrs
    ...
    % save
    save([fpath 'Data_ipsl_ssp126_daily_',num2str(yr),'.mat'], 'ESM');
