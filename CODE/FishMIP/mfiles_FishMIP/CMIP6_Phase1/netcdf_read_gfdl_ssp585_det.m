...
%%
ncdisp([fpath 'gfdl-esm4_r1i1p1f1_ssp585_expc-bot_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'gfdl-esm4_r1i1p1f1_ssp585_expc-bot_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
save([fpath 'gfdl_ssp585_det_btm_monthly_2015_2100.mat'],'det_btm','time',...
