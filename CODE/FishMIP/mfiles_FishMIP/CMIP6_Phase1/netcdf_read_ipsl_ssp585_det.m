...
%%
ncdisp([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_expc-bot_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp585_expc-bot_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
save([fpath 'ipsl_ssp585_det_btm_monthly_2015_2100.mat'],'det_btm','time',...
    'yr','long_name','standard_name','units');
save([spath 'ipsl_ssp585_det_btm_monthly_2015_2100.mat'],'det_btm','time',...
    'yr','long_name','standard_name','units');
