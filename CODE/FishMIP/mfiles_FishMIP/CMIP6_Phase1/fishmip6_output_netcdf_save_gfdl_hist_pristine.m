...
load([fpath 'Hist_empHP_fishMIP_outputs_monthly_' cfile '.mat'])
...
%e.g.
%apecosm_gfdl-esm4_nobc_picontrol_histsoc_default_tcb_global_monthly_2001_2010.nc
...
% 
% lon_dim = netcdf.defDim(ncid60,'longitude',ni);
% lat_dim = netcdf.defDim(ncid60,'latitude',nj);
% time_dim = netcdf.defDim(ncid60,'time',nt);
% 
% vidlat = netcdf.defVar(ncid60,'LAT','double',[lon_dim,lat_dim]);
% netcdf.putAtt(ncid60,vidlat,'long_name','latitude');
% netcdf.putAtt(ncid60,vidlat,'units','degrees');
% 
% vidlon = netcdf.defVar(ncid60,'LON','double',[lon_dim,lat_dim]);
% netcdf.putAtt(ncid60,vidlon,'long_name','longitude');
% netcdf.putAtt(ncid60,vidlon,'units','degrees' );
% 
% vidt60 = netcdf.defVar(ncid60,'time','double',time_dim);
% netcdf.putAtt(ncid60,vidt60,'long_name','time');
% netcdf.putAtt(ncid60,vidt60,'units','years' );
% 
