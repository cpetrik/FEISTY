...
load('/Volumes/MIP/Fish-MIP/CMIP6/GFDL/hist/gfdl_hist_temp_btm_monthly_1950_2014.mat','time',...
    'yr','runs');
t_all = time;
time = time(runs);
...
%e.g.
%apecosm_gfdl-esm4_nobasd_picontrol_histsoc_default_tcb_global_monthly_2001_2010.nc
