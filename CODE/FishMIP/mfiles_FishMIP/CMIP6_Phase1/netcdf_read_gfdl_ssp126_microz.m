...
%% zmicro
ncdisp([fpath 'gfdl-esm4_r1i1p1f1_ssp126_zmicro_onedeg_global_monthly_2015_2100.nc'])
...
%%
ncid = netcdf.open([fpath 'gfdl-esm4_r1i1p1f1_ssp126_zmicro_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%% 
save([fpath 'gfdl_ssp126_zmicro100_monthly_2015_2100.mat'],'zmicro_100','time',...
