...
%%
ncid = netcdf.open([fpath 'ipsl-cm6a-lr_r1i1p1f1_ssp126_zmeso_onedeg_global_monthly_2015_2100.nc'],'NC_NOWRITE');
...
%%
save([fpath 'ipsl_ssp126_zmeso_100_monthly_2015_2100.mat'],'zmeso_100','time',...
    'yr','long_name','standard_name','units_orig','units_vint','olevel','z100');
save([spath 'ipsl_ssp126_zmeso_100_monthly_2015_2100.mat'],'zmeso_100','time',...
    'yr','long_name','standard_name','units_orig','units_vint','olevel','z100');
