...
load([fpath 'gfdl_ssp126_temp_100_monthly_2015_2100.mat'],'temp_100');
load([fpath 'gfdl_ssp126_temp_btm_monthly_2015_2100.mat'],'temp_btm');
load([fpath 'gfdl_ssp126_zmeso_100_monthly_2015_2100.mat'],'zmeso_100');
...
s2time=time;
s2yrs=yrs;
save([fpath 'gfdl_ssp126_inputs_ts_nanmeans.mat'],'s2time','s2yrs',...
