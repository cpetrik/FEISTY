...
load([fpath 'SSP126_empHP_fishMIP_outputs_monthly_' cfile '.mat'])
...
load('/Volumes/MIP/Fish-MIP/CMIP6/GFDL/ssp126/gfdl_ssp126_temp_btm_monthly_2015_2100.mat',...
    'time','yr');
t_all = time;
...
fname1 = 'feisty_gfdl-esm4_nobasd_ssp126_nat_default_';
