...
test=squeeze(double(temp_100(:,:,95)));
pcolor(test)
colorbar

%% save
save([fpath 'ipsl_ssp585_temp_100_monthly_2015_2100.mat'],'temp_100','time',...
    'yr','long_name','standard_name','units','olevel','z100');
save([spath 'ipsl_ssp585_temp_100_monthly_2015_2100.mat'],'temp_100','time',...
    'yr','long_name','standard_name','units','olevel','z100');
