...
load([fpath 'Means_SSP585_empHP_2090-2100_' cfile '.mat']);
...
title('SSP585')
stamp(mod)
print('-dpng',[ppath 'SSP585_empHP_',mod,'_all_sizes.png'])
...
title('SSP585')
stamp(mod)
print('-dpng',[ppath 'SSP585_empHP_',mod,'_all_types.png'])
...
stamp(mod)
print('-dpng',[ppath 'SSP585_empHP_',mod,'_global_BENT.png'])
...
stamp(mod)
print('-dpng',[ppath 'SSP585_empHP_',mod,'_global_All_subplot.png'])
...
stamp(mod)
print('-dpng',[ppath 'SSP585_empHP_',mod,'_global_ratios_subplot.png'])
