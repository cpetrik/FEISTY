...
ncid = netcdf.open([fpath 'cesm_rcp85_zoo_zint_monthly_',num2str(tstart(t)),'-',...
...
% save([fpath 'cesm_rcp85_zoo_zint_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_rcp85_zoo_zint_monthly_',num2str(tstart(1)),'-',...
