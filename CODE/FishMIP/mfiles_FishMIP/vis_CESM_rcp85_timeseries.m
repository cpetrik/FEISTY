...
% xlim([y(1) y(end)])
% title('Forecast 3km Large Pelagics')
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Forecast_',harv,'_P_time.png'])
% 
% % Forage fishes
% figure(2)
% subplot(3,1,1)
...
% xlim([y(1) y(end)])
% title('Forecast 3km Forage Fishes')
% ylabel('log10 Biomass (g m^-^2)')
...
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% print('-dpng',[ppath 'Forecast_',harv,'_F_time.png'])
% 
% % Demersals
% figure(3)
% subplot(4,1,1)
...
% xlim([y(1) y(end)])
% title('Forecast 3km Demersal Piscivores')
% legend('Larvae','Juveniles','Adults')
% legend('location','southeast')
% stamp(cfile)
% 
...
% title('Adults')
% xlabel('Time (mo)')
% print('-dpng',[ppath 'Forecast_',harv,'_D_time.png'])
% 
% % Benthic inverts
% figure(4)
% subplot(2,1,1)
...
% xlim([y(1) y(end)])
% title('Forecast 3km Benthic Inverts')
% xlabel('Time (mo)')
% ylabel('log10 Biomass (g m^-^2)')
% 
% subplot(2,1,2)
...
% print('-dpng',[ppath 'Forecast_',harv,'_B_time.png'])
...
title(['Forecast ' harv])
stamp(cfile)
print('-dpng',[ppath 'Forecast_',harv,'_ts_all_sizes.png'])
...
title(['Forecast ' harv])
stamp(cfile)
print('-dpng',[ppath 'Forecast_',harv,'_ts_all_types.png'])
...
xlim([y(1) y(end)])
title(['Forecast ' harv ' biomass (g m^-^2)'])
ylabel('Forage fish')
...
stamp(cfile)
print('-dpng',[ppath 'Forecast_',harv,'_all_types_subplot.png'])
