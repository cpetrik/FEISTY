...
load([hpath 'cesm_hist_phy_zint_monthly_185001-200512.mat'],'np_int');
load([hpath 'cesm_hist_zoo_zint_monthly_185001-200512.mat'],'nz_int');
hist_np_int = np_int;
hist_nz_int = nz_int;
clear np_int nz_int

load([rpath 'cesm_rcp85_phy_zint_monthly_200601-210012.mat'],'np_int');
load([rpath 'cesm_rcp85_zoo_zint_monthly_200601-210012.mat'],'nz_int');
rcp_np_int = np_int;
rcp_nz_int = nz_int;
clear np_int nz_int

np_int = cat(3, hist_np_int, rcp_np_int);
nz_int = cat(3, hist_nz_int, rcp_nz_int);

clear hist_np_int hist_nz_int rcp_np_int rcp_nz_int 
...
save([fpath 'FishMIP_output_Temp_cont_' cfile '.mat'],'Years',...
