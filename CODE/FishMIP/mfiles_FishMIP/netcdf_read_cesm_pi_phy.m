...
ncid = netcdf.open([fpath 'cesm_pi_phy_zint_monthly_',num2str(tstart(t)),'-',...
...
% save([fpath 'cesm_pi_phy_zint_monthly_',num2str(tstart(t)),'-',...
...
save([fpath 'cesm_pi_phy_zint_monthly_',num2str(tstart(1)),'-',...
