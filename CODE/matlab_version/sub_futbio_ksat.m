...
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,ENVR] = sub_futbio_ksat(ID,DY,COBALT,ENVR,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,dfrate)
...
% Consumption rates
Sf.con_zm = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Sf.td,M_s,Sf.enc_zm);
Sp.con_zm = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Sp.td,M_s,Sp.enc_zm);
Sd.con_zm = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Sd.td,M_s,Sd.enc_zm);

Mf.con_zm = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mf.td,M_m,[Mf.enc_zm,Mf.enc_zl,Mf.enc_f,Mf.enc_p,Mf.enc_d]);
Mf.con_zl = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mf.td,M_m,[Mf.enc_zl,Mf.enc_zm,Mf.enc_f,Mf.enc_p,Mf.enc_d]);
Mf.con_f  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mf.td,M_m,[Mf.enc_f,Mf.enc_zm,Mf.enc_zl,Mf.enc_p,Mf.enc_d]);
Mf.con_p  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mf.td,M_m,[Mf.enc_p,Mf.enc_zm,Mf.enc_zl,Mf.enc_f,Mf.enc_d]);
Mf.con_d  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mf.td,M_m,[Mf.enc_d,Mf.enc_zm,Mf.enc_zl,Mf.enc_f,Mf.enc_p]);

Mp.con_zm = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mp.td,M_m,[Mp.enc_zm,Mp.enc_zl,Mp.enc_f,Mp.enc_p,Mp.enc_d]);
Mp.con_zl = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mp.td,M_m,[Mp.enc_zl,Mp.enc_zm,Mp.enc_f,Mp.enc_p,Mp.enc_d]);
Mp.con_f  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mp.td,M_m,[Mp.enc_f,Mp.enc_zm,Mp.enc_zl,Mp.enc_p,Mp.enc_d]);
Mp.con_p  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mp.td,M_m,[Mp.enc_p,Mp.enc_zm,Mp.enc_zl,Mp.enc_f,Mp.enc_d]);
Mp.con_d  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Mp.td,M_m,[Mp.enc_d,Mp.enc_zm,Mp.enc_zl,Mp.enc_f,Mp.enc_p]);

Md.con_be = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Md.td,M_m,Md.enc_be);

Lp.con_f  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Lp.td,M_l,[Lp.enc_f,Lp.enc_p,Lp.enc_d]);
Lp.con_p  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Lp.td,M_l,[Lp.enc_p,Lp.enc_f,Lp.enc_d]);
Lp.con_d  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Lp.td,M_l,[Lp.enc_d,Lp.enc_p,Lp.enc_f]);

Ld.con_f  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Ld.td,M_l,[Ld.enc_f,Ld.enc_p,Ld.enc_d,Ld.enc_be]);
Ld.con_p  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Ld.td,M_l,[Ld.enc_p,Ld.enc_f,Ld.enc_d,Ld.enc_be]);
Ld.con_d  = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Ld.td,M_l,[Ld.enc_d,Ld.enc_p,Ld.enc_f,Ld.enc_be]);
Ld.con_be = sub_cons_ksat(ENVR.Tp,ENVR.Tb,Ld.td,M_l,[Ld.enc_be,Ld.enc_f,Ld.enc_p,Ld.enc_d]);
...
[Mf.gamma,Mf.nu,Mf.rep] = sub_rep(NX,Mf.gamma,Mf.nu,K_a);
[Lp.gamma,Lp.nu,Lp.rep] = sub_rep(NX,Lp.gamma,Lp.nu,K_a);
[Ld.gamma,Ld.nu,Ld.rep] = sub_rep(NX,Ld.gamma,Ld.nu,K_a);
...
% Mass balance
[Sf.bio, Sf.mort] = sub_update_fi(Sf.bio,Sf.rec,Sf.nu,Sf.rep,Sf.gamma,Sf.die,Sf.egg,Sf.nmort);
[Sp.bio, Sp.mort] = sub_update_fi(Sp.bio,Sp.rec,Sp.nu,Sp.rep,Sp.gamma,Sp.die,Sp.egg,Sp.nmort);
[Sd.bio, Sd.mort] = sub_update_fi(Sd.bio,Sd.rec,Sd.nu,Sd.rep,Sd.gamma,Sd.die,Sd.egg,Sd.nmort);

[Mf.bio, Mf.mort] = sub_update_fi(Mf.bio,Mf.rec,Mf.nu,Mf.rep,Mf.gamma,Mf.die,Mf.egg,Mf.nmort);
[Mp.bio, Mp.mort] = sub_update_fi(Mp.bio,Mp.rec,Mp.nu,Mp.rep,Mp.gamma,Mp.die,Mp.egg,Mp.nmort);
[Md.bio, Md.mort] = sub_update_fi(Md.bio,Md.rec,Md.nu,Md.rep,Md.gamma,Md.die,Md.egg,Md.nmort);

[Lp.bio, Lp.mort] = sub_update_fi(Lp.bio,Lp.rec,Lp.nu,Lp.rep,Lp.gamma,Lp.die,Lp.egg,Lp.nmort);
[Ld.bio, Ld.mort] = sub_update_fi(Ld.bio,Ld.rec,Ld.nu,Ld.rep,Ld.gamma,Ld.die,Ld.egg,Ld.nmort);
