...
function Pre_industrial_long_pred()
...
S_Sml_f_pred = zeros(NX,DAYS);
S_Sml_p_pred = zeros(NX,DAYS);
S_Sml_d_pred = zeros(NX,DAYS);
S_Med_f_pred = zeros(NX,DAYS);
S_Med_p_pred = zeros(NX,DAYS);
S_Med_d_pred = zeros(NX,DAYS);
S_Lrg_p_pred = zeros(NX,DAYS);
S_Lrg_d_pred = zeros(NX,DAYS);
...
file_sml_f = [fname,'_pred_sml_f.nc'];
file_sml_p = [fname,'_pred_sml_p.nc'];
file_sml_d = [fname,'_pred_sml_d.nc'];
file_med_f = [fname,'_pred_med_f.nc'];
file_med_p = [fname,'_pred_med_p.nc'];
file_med_d = [fname,'_pred_med_d.nc'];
file_lrg_p = [fname,'_pred_lrg_p.nc'];
file_lrg_d = [fname,'_pred_lrg_d.nc'];
