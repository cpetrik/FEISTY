%%%% File naming system
function [fname,simname] = sub_fname_core_spin_fished_obs_data()
...
if (~isfolder(['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',simname,'/CORE']))
    mkdir(['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',simname,'/CORE'])
end

%! Setup netcdf path to store to
if (Jsel~=0.1)
    fname = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',simname, '/CORE/Core_spin_', sel,'_fish_',tfish,'_Juve',tJ(2:end)];
elseif (MFsel~=LPsel)
    fname = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',simname, '/CORE/Core_spin_fish_F',tF,'_P',tP,'_D',tD];
else
    fname  = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',simname, '/CORE/Core_spin_', sel,'_fish_',tfish];
end
