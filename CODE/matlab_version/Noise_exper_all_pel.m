%%%%!! RUN NOISE COLOR EXPER ON BIOME CLIMATOLOGIES
function Noise_exper_all_pel()
...
[fname,simname] = sub_fname_exper_pel(frate);
...
load('/Volumes/MIP/GCM_DATA/CORE-forced/cobalt_biome_core_noise_mz_mhp.mat',...
    'mz_clim_spl_rep_backtrans','mhp_clim_spl_rep_backtrans');
load('/Volumes/MIP/GCM_DATA/CORE-forced/cobalt_biome_core_noise_lz_lhp.mat',...
    'lz_clim_spl_rep_backtrans','lhp_clim_spl_rep_backtrans');
load('/Volumes/MIP/GCM_DATA/CORE-forced/cobalt_biome_core_noise_tp.mat',...
    'tp_clim_spl_rep_backtrans');
...
for YR = 1:YEARS % years
    ...
    COBALT.Zm = mz_clim_spl_rep_backtrans(:,st(YR):en(YR));
    COBALT.dZm = mhp_clim_spl_rep_backtrans(:,st(YR):en(YR));
    COBALT.Zl = lz_clim_spl_rep_backtrans(:,st(YR):en(YR));
    COBALT.dZl = lhp_clim_spl_rep_backtrans(:,st(YR):en(YR));
    COBALT.Tp = tp_clim_spl_rep_backtrans(:,st(YR):en(YR));
