...
function Historic_fished_cmax_ensemble6()
...
pset2 = unique(pstats(:,1)); 
psets = unique([pset1;pset2]);
...
%     S_Lrg_d_fish = zeros(NX,DAYS);
    ...
    file_sml_f = [fname,'_cmax_sml_f.nc'];
    file_sml_p = [fname,'_cmax_sml_p.nc'];
    file_sml_d = [fname,'_cmax_sml_d.nc'];
    file_med_f = [fname,'_cmax_med_f.nc'];
    file_med_p = [fname,'_cmax_med_p.nc'];
    file_med_d = [fname,'_cmax_med_d.nc'];
    file_lrg_p = [fname,'_cmax_lrg_p.nc'];
    file_lrg_d = [fname,'_cmax_lrg_d.nc'];
    file_bent  = [fname,'_cmax_bent.nc'];
