...
file_sml_f = [fname,'_rec_rep_nmort_sml_f.nc'];
file_sml_p = [fname,'_rec_rep_nmort_sml_p.nc'];
file_sml_d = [fname,'_rec_rep_nmort_sml_d.nc'];
file_med_f = [fname,'_rec_rep_nmort_med_f.nc'];
file_med_p = [fname,'_rec_rep_nmort_med_p.nc'];
file_med_d = [fname,'_rec_rep_nmort_med_d.nc'];
file_lrg_p = [fname,'_rec_rep_nmort_lrg_p.nc'];
file_lrg_d = [fname,'_rec_rep_nmort_lrg_d.nc'];
