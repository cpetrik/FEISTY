...
function Spinup_CORE_fished_obs_server()

global DAYS GRD NX ID
global DT PI_be_cutoff pdc L_s L_m L_l M_s M_m M_l L_zm L_zl
global Z_s Z_m Z_l Lambda K_l K_j K_a h gam kt bpow
global bent_eff rfrac D J Sm A benc bcmx amet  kc ke
...
%! Set fishing rate as 1st year of observations
...
load(['/Volumes/petrik-lab/Feisty/GCM_Data/CORE-forced/Data_ocean_cobalt_daily_',...
    num2str(year(1)),'.mat'],'COBALT');
...
load('/Volumes/petrik-lab/Feisty/GCM_Data/CORE-forced/Data_grid_ocean_cobalt_ESM2Mcore.mat','GRD');
NX = GRD.N;
ID = 1:NX;

%! Create a directory for output
[fname,simname] = sub_fname_core_spin_fished_obs_server();
...
for YR = 1:YEARS % years
    ...
    for DAY = 1:DT:DAYS % days
        ...
        [Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,ENVR] = ...
            sub_futbio_fished_obs(DY,COBALT,ENVR,Sml_f,Sml_p,Sml_d,...
