...
function make_parameters_be2()
    ...
    global tstep K frate kc ke fracSB
    ...
    %%%! Benthic prey
    bent_eff = 0.075;   % Transfer efficiency of detritus to benthos
    fracSB = 0.75;      % Fraction of detritus that becomes small benthos
