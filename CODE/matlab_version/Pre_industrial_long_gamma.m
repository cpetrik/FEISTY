...
function Pre_industrial_long_gamma()
...
file_sml_f = [fname,'_gamma_sml_f.nc'];
file_sml_p = [fname,'_gamma_sml_p.nc'];
file_sml_d = [fname,'_gamma_sml_d.nc'];
file_med_f = [fname,'_gamma_med_f.nc'];
file_med_p = [fname,'_gamma_med_p.nc'];
file_med_d = [fname,'_gamma_med_d.nc'];
file_lrg_p = [fname,'_gamma_lrg_p.nc'];
file_lrg_d = [fname,'_gamma_lrg_d.nc'];
