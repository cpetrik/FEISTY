...
load([dp 'Climatol_diff_Frates_F2.mat']);
...
xlabel('F')
title('All')
print('-dpng',[ppath 'Climatol_global_yield_diff_Frates_F2.png'])
...
print('-dpng',[ppath 'Climatol_LME_yield_diff_Frates_F2_All.png'])
...
print('-dpng',[ppath 'Climatol_LME_yield_diff_Frates_F2_F.png'])
...
print('-dpng',[ppath 'Climatol_LME_yield_diff_Frates_F2_P.png'])
...
print('-dpng',[ppath 'Climatol_LME_yield_diff_Frates_F2_D.png'])
...
xlabel('F')
title('All')
print('-dpng',[ppath 'Climatol_yield_diff_Frates_F2_SAUPcomp_rcorr.png'])
...
xlabel('F')
title('All')
print('-dpng',[ppath 'Climatol_yield_diff_Frates_F2_SAUPcomp_rmse.png'])
...
print('-dpng',[ppath 'Climatol_LME_select_yield_diff_Frates_F2_P.png'])
...
print('-dpng',[ppath 'Climatol_LME_select_yield_diff_Frates_F2_D.png'])
...
for i = 1:length(lmes)
        ...
        title(num2str(L))
        ylabel('P Catch')
        xlabel('Fishing rate on F (yr^-^1)')
        print('-dpng',[ppath 'LMEs/Climatol_LME',num2str(L),'_yield_diff_Frates_F2_P.png'])
end
...
for i = 1:length(lmes)
        ...
        ylabel('D Catch')
        xlabel('Fishing rate on F (yr^-^1)')
        print('-dpng',[ppath 'LMEs/Climatol_LME',num2str(L),'_yield_diff_Frates_F2_D.png'])
end
