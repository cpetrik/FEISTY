...
title('All fishes')
% stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_types_temp_Stock_AtlGoM_pvals.png'])
...
title('Climatology')
print('-dpng',[ppath 'Clim_',harv,'_SAUP_comp_Stock_AtlGoM_all.png'])
