...
%Corr
subplot('Position',[0.55 0.1 0.41 0.4])
plot(x,x,'--k');hold on;
scatter(l10sF(5:7),l10pF(5:7),50,'k','filled'); hold on;
axis([-3.5 1.5 -3.5 1.5])
xlabel('SAU log_1_0 F catch (MT)')
ylabel('FEISTY log_1_0 F catch (MT)')
text(-3.15,1.1,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_F_SAUP_comp_subplot_corr.png'])
...
subplot('Position',[0.55 0.1 0.41 0.4])
plot(x,x,'--k');hold on;
scatter(l10sP(5:7),l10pP(5:7),50,'k','filled'); hold on;
axis([-1.5 1.5 -1.5 1.5])
xlabel('SAU log_1_0 P catch (MT)')
ylabel('FEISTY log_1_0 P catch (MT)')
text(-1.3,1.2,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_P_SAUP_comp_subplot_corr.png'])
...
subplot('Position',[0.55 0.1 0.41 0.4])
plot(x,x,'--k');hold on;
scatter(l10sD(5:7),l10pD(5:7),50,'k','filled'); hold on;
axis([-1.5 1.5 -1.5 1.5])
xlabel('SAU log_1_0 D catch (MT)')
ylabel('FEISTY log_1_0 D catch (MT)')
text(-1.3,1.2,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_D_SAUP_comp_subplot_corr.png'])
...
subplot('Position',[0.55 0.1 0.41 0.4])
plot(x,x,'--k');hold on;
scatter(l10s(5:7),l10p(5:7),50,'k','filled'); hold on;
axis([-1 1.5 -1 1.5])
xlabel('SAU log_1_0 All catch (MT)')
ylabel('FEISTY log_1_0 All catch (MT)')
text(-0.875,1.2,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_All_SAUP_comp_subplot_corr.png'])
...
subplot('Position',[0.55 0.1 0.41 0.4])
plot(x,x,'--k');hold on;
scatter(sFracPD(5:7),pFracPD(5:7),50,'k','filled'); hold on;
axis([0 1 0 1])
xlabel('SAU fraction large pelagics in catch')
ylabel('FEISTY fraction large pelagics in catch')
text(0.05,0.9,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_PD_SAUP_comp_subplot_corr.png'])
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
caxis([-1 1]);
colorbar('Position',[0.47 0.275 0.025 0.5])                   
set(gcf,'renderer','painters')
text(-0.4,0.95,'A','FontSize',14)
...
caxis([-1 1]);
set(gcf,'renderer','painters')
text(-0.4,0.95,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_AtlGoM_LMEs_AllDiffs_SAUP_comp_subplot.png'])
