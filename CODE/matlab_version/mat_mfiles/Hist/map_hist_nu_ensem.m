function map_hist_nu_ensem(simname,sf_nu50,sp_nu50,sd_nu50,...
    mf_nu50,mp_nu50,md_nu50,lp_nu50,ld_nu50,pp)

% Visualize output of FEISTY
% Historic time period (1951-2000) at all locations
% 145 years
% Saved as mat files
...
text(-2.75,1.75,'F')
print('-dpng',[pp 'Hist_nu_types_6plot_',simname,'.png'])
...
colorbar
set(gcf,'renderer','painters')
title('mean nu All adult fishes (g m^-^2 d^-1)')
stamp(simname)
print('-dpng',[pp 'Hist_nu_All_',simname,'.png'])
