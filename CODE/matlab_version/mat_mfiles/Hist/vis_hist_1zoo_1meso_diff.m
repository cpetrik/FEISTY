...
% ESM2M Hindcast w/1 zoo and 1 meso, 
% both include no overconsump from HPloss
...
%% 1 zoo application of baseline FEISTY
cfile2 = 'Dc_enc70-b200_m4-b175-k086_c20-b250_D075_J100_A050_Sm100_nmort1_BE08_noCC_RE00100';
...
load([fpath2 'Means_Historic_1zoo_',harv,'_' cfile2 '.mat'],...
    'sf_mean50','sp_mean50','sd_mean50',...
    'mf_mean50','mp_mean50','md_mean50',...
    'lp_mean50','ld_mean50','b_mean50','Fish1zoo');
...
set(gcf,'renderer','painters')
title('1 meso F');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_F.png'])
...
set(gcf,'renderer','painters')
title('1 meso P');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_P.png'])
...
set(gcf,'renderer','painters')
title('1 meso D');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_D.png'])
...
set(gcf,'renderer','painters')
title('1 meso All');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_All.png'])
...
colorbar
set(gcf,'renderer','painters')
title('1 meso Benthos');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_Bent.png'])
...
set(gcf,'renderer','painters')
title('1 meso P/(P+D)');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_PD.png'])
...
set(gcf,'renderer','painters')
title('1 meso P/(P+F)');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_PF.png'])
...
set(gcf,'renderer','painters')
title('1 meso L/(L+M)');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_LM.png'])
...
colorbar
set(gcf,'renderer','painters')
title('All 1 meso - 1 zoo');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_pdiff_fish.png'])
...
colorbar
set(gcf,'renderer','painters')
title('B 1 meso - 1 zoo');
print('-dpng',[pp 'Meso1_Zoo1_' harv '_global_pdiff_fracs.png'])
...
figure(11)
plot(y,log10(Fish1meso),'-'); hold on;
plot(y,log10(Fish1zoo),'--.')
legend('SF','SP','SD','MF','MP','MD','LP','LD','B')
legend('location','eastoutside')
xlim([1865 2005])
print('-dpng',[pp 'Meso1_Zoo1_' harv '_ts_stages.png'])
