...
ppath = [pp cfile '/'];
dpath = [dp cfile '/'];
load([dpath 'LME_Hist_1zoo_',harv,'_' cfile '.mat']);
...
writetable(Fstat,[dpath 'Hist_1zoo_LME_DvD_SAU_stats_' cfile '.csv'],'Delimiter',',','WriteRowNames',true)
save([dpath 'Hist_1zoo_LME_DvD_SAU_stats_' cfile '.mat'],'fish_stat')
...
%title('Fraction Large Pelagics')
%stamp(cfile)
print('-dpng',[ppath 'Hist_1zoo_' harv '_LME_fracPD_catch_SAUP_DvD_comp_subplot.png'])
