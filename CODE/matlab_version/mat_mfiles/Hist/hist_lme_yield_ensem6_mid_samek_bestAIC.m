...
% varying 5 most sensitive params plus same k's
...
save([lpath 'LME_ts_yield_Historic_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
    'Hlme_tsc_mf','Hlme_tsc_mp','Hlme_tsc_md','Hlme_tsc_lp','Hlme_tsc_ld',...
    'units_catch')
save([nfile 'LME_ts_yield_Historic_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
    'Hlme_tsc_mf','Hlme_tsc_mp','Hlme_tsc_md','Hlme_tsc_lp','Hlme_tsc_ld',...
    'units_catch')
