function netcdf_read_hist_fished_nu_ens(fname,simname)
...
sp_nu50=nanmean(SP.nu(:,yr50),2);
sf_nu50=nanmean(SF.nu(:,yr50),2);
sd_nu50=nanmean(SD.nu(:,yr50),2);
mp_nu50=nanmean(MP.nu(:,yr50),2);
mf_nu50=nanmean(MF.nu(:,yr50),2);
md_nu50=nanmean(MD.nu(:,yr50),2);
lp_nu50=nanmean(LP.nu(:,yr50),2);
ld_nu50=nanmean(LD.nu(:,yr50),2);
...
%%
save([fname '_Means_nu_' simname '.mat'],'time',...
    'y','yr50',...
