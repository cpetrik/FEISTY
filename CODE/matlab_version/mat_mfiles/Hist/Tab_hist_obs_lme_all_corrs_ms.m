...
l10L = log10(lme_te(:,2));
l10HTL = log10(lme_te(:,4));
l10LTL = log10(lme_te(:,6));
...
writetable(Fstat,[fpath 'Hist_obs_LME_all_ms_stats_' cfile '.csv'],'Delimiter',',',...
    'WriteRowNames',true)
save([fpath 'Hist_obs_LME_all_ms_stats_' cfile '.mat'],'fish_stat')
