...
% ESM2M Hindcast w/2 zoo and 1 zoo
...
load([fpath1 'Historic_ESM2M/Means_Historic_',harv,'_' cfile1 '.mat'],...
    'sf_mean50','sp_mean50','sd_mean50',...
    'mf_mean50','mp_mean50','md_mean50',...
    'lp_mean50','ld_mean50','b_mean50','HistFish');
...
set(gcf,'renderer','painters')
title('2 zoo F');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_F.png'])
...
set(gcf,'renderer','painters')
title('2 zoo P');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_P.png'])
...
set(gcf,'renderer','painters')
title('2 zoo D');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_D.png'])
...
set(gcf,'renderer','painters')
title('2 zoo All');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_All.png'])
...
set(gcf,'renderer','painters')
title('2 zoo Benthos');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_Bent.png'])
...
set(gcf,'renderer','painters')
title('2 zoo P/(P+D)');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_PD.png'])
...
set(gcf,'renderer','painters')
title('2 zoo P/(P+F)');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_PF.png'])
...
set(gcf,'renderer','painters')
title('2 zoo L/(L+M)');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_LM.png'])
...
colorbar
set(gcf,'renderer','painters')
title('All 2 zoo - 1 zoo');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_pdiff_fish.png'])
...
set(gcf,'renderer','painters')
title('B 2 zoo - 1 zoo');
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_global_pdiff_fracs.png'])
...
figure(11)
plot(y,log10(HistFish),'-'); hold on;
plot(y,log10(Fish1zoo),'--')
legend('SF','SP','SD','MF','MP','MD','LP','LD','B')
legend('location','eastoutside')
xlim([1865 2005])
print('-dpng',[pp 'Zoo2_Zoo1_' harv '_ts_stages.png'])
