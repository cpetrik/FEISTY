...
%% save
writetable(Q,[fpath 'TEeff_quant_Historic_1zoo_All_fish03_' cfile '.csv'],'Delimiter',',');

save([fpath 'TEeffDet_Historic_1zoo_All_fish03_' cfile '.mat'],'TEeffM',...
...
% text(-2.75,1.25,'C')
% %stamp([harv '_' cfile])
% print('-dpng',[ppath 'Historic_1zoo_' harv '_global_DeffTEs_subplot.png'])
% 
...
% title('B. TE HTL')
% %stamp([harv '_' cfile])
% print('-dpng',[ppath 'Historic_1zoo_' harv '_global_DTEs_subplot.png'])
