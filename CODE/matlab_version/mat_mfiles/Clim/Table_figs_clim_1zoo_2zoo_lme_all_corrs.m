% All correlations between Clim w/ 2 zoo and 1 mesoz (Sm=1)
clear all
close all
...
writetable(Fstat,[dpath 'LME_clim_2zoo_1zoo_stats_' cfile '.csv'],'Delimiter',',',...
    'WriteRowNames',true)
save([dpath 'LME_clim_2zoo_1zoo_stats_' cfile '.mat'],'fish_stat')
...
title('All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_2zoo_1zoo_',harv,'_comp_types_temp.png'])
...
title('Benthos')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_2zoo_1zoo_',harv,'_comp_fracs_temp.png'])
...
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_2zoo_1zoo_',harv,'_comp_TEeffs_temp.png'])
