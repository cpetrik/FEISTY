...
for n = 1:length(kays)
    ...
    %total biomass caught (over year)
    ...
    %% Total mortality w/o fishing (all rates per biomass)
    Fmort = Fpred + Fnat;
    Pmort = Ppred + Pnat;
    Dmort = Dpred + Dnat;
