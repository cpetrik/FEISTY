...
det_smean = squeeze(mean(tdet_amean,2,'omitnan'));

%%
save([fpath 'Time_Means_gfdl_cmip6_hist_2meso_daily.mat'],'time',...
    'tb_tmean','tp_tmean','mz_tmean',...
    'mzhp_tmean','lz_tmean','lzhp_tmean',...
    'det_tmean')

save([fpath 'Space_Means_gfdl_cmip6_hist_2meso_daily.mat'],'time',...
    'tb_smean','tp_smean','mz_smean',...
    'mzhp_smean','lz_smean','lzhp_smean',...
    'det_smean')

save([fpath 'Annual_Means_gfdl_cmip6_hist_2meso_daily.mat'],'time',...
