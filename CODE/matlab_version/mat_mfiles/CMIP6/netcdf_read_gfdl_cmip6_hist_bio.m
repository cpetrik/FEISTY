...
mod = 'Historic_const_spawning_All_fish03_';
...
%%
save([fpath 'Time_Means_' mod cfile '_v2.mat'],'time',...
    'sf_tmean','sp_tmean','sd_tmean',...
    'mf_tmean','mp_tmean','md_tmean',...
    'lp_tmean','ld_tmean','b_tmean')

save([fpath 'Space_Means_' mod cfile '_v2.mat'],'time',...
    'sf_sbio','sp_sbio','sd_sbio',...
    'mf_sbio','mp_sbio','md_sbio',...
    'lp_sbio','ld_sbio','b_sbio')

save([fpath 'Annual_Means_' mod cfile '_v2.mat'],'time',...
