...
print('-dpng','Clearance_comp_mass_big_sizes.png')
...
print('-dpng','Ingestion_comp_mass_big_sizes.png')
...
print('-dpng','Respiration_comp_mass_big_sizes.png')
...
legend('location','southwest')
title('Specific respiration rate')
print('-dpng','Respiration_comp_fcrit_big_sizes.png')
...
print('-dpng','Mortality_comp_mass_big_sizes.png')
...
title('Specific clearance rate')
print('-dpng','Clearance_comp_temp_big_sizes.png')
...
legend('location','west')
title('Specific ingestion rate')
print('-dpng','Ingestion_comp_temp_big_sizes.png')
...
legend('location','west')
title('Specific respiration rate')
print('-dpng','Respiration_comp_temp_big_sizes.png')
...
print('-dpng','Mortality_comp_temp_big_sizes.png')
