...
%Me
Mmet = exp(0.063*(temp-15.0)) .* 0.3*Mcmax;
...
print('-dpng','Clearance_comp_mass_JC.png')
...
print('-dpng','Ingestion_comp_mass_JC.png')
...
print('-dpng','Respiration_comp_mass_JC.png')
...
plot(log10(m),log10(0.4*Mcmax),'.c','MarkerSize',25); hold on;
plot(log10(m),log10(0.5*Mcmax),'.m','MarkerSize',25); hold on;
ylabel('log10 respiration (gWW gWW^-^1 d^-^1)')
xlabel('log10 weight (gWW)')
legend('Hart','J&C','mizer','fcrit30','fcrit10','fcrit20','fcrit40','fcrit50')
legend('location','southwest')
title('Specific respiration rate')
print('-dpng','Respiration_comp_fcrit_JC.png')
...
print('-dpng','Mortality_comp_mass_JC.png')
...
title('Specific clearance rate')
print('-dpng','Clearance_comp_temp_JC.png')
...
legend('location','west')
title('Specific ingestion rate')
print('-dpng','Ingestion_comp_temp_JC.png')
...
legend('location','west')
title('Specific respiration rate')
print('-dpng','Respiration_comp_temp_JC.png')
...
print('-dpng','Mortality_comp_temp_JC.png')
