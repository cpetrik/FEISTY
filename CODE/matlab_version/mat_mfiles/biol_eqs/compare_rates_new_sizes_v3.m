...
print('-dpng','Clearance_comp_mass_new_sizes_v3.png')
...
print('-dpng','Ingestion_comp_mass_new_sizes_v3.png')
...
print('-dpng','Respiration_comp_mass_new_sizes_v3.png')
...
print('-dpng','Mortality_comp_mass_new_sizes_v3.png')
...
print(f5,'-dpng','Clearance_comp_temp_new_sizes_v3.png')
print(f6,'-dpng','Ingestion_comp_temp_new_sizes_v3.png')
print(f7,'-dpng','Respiration_comp_temp_new_sizes_v3.png')
print(f8,'-dpng','Mortality_comp_temp_new_sizes_v3.png')

%%
JuS = exp((-1*E/k)*((1./temp2)-(1./Tref))) .* (U.*mass(1).^(-N))/365;
JuM = exp((-1*E/k)*((1./temp2)-(1./Tref))) .* (U.*mass(2).^(-N))/365;
JuL = exp((-1*E/k)*((1./temp2)-(1./Tref))) .* (U.*mass(3).^(-N))/365;
JuO = exp((-1*E/k)*((1./temp2)-(1./Tref))) .* (U.*250.^(-N))/365;
    
Cu = 0.1/365 * ones(size(temp));
    
figure(9);
%plot(temp,log10(Hu),'-b','MarkerSize',15,'LineWidth',2); hold on;
plot(temp,log10(JuS),':k','MarkerSize',15,'LineWidth',2); hold on;
plot(temp,log10(JuM),'--k','MarkerSize',15,'LineWidth',2); hold on;
plot(temp,log10(JuL),'-k','MarkerSize',15,'LineWidth',2); hold on;
%plot(temp,log10(Zu),'-','color',[0.5 0.5 0.5],'MarkerSize',15,'LineWidth',2); hold on;
plot(temp,log10(Cu),'-','color',[0 0.5 0.75],'MarkerSize',15,'LineWidth',2); hold on;
plot(temp,log10(JuO),'-b','MarkerSize',15,'LineWidth',2); hold on;
ylabel('log10 mortality rate (d^-^1)')
xlabel('temp (^oC)')
xlim([-2 30])
legend('J&C S','J&C M','J&C L','me')
legend('location','northwest')
title('Daily mortality rate')
%print('-dpng','JC_Mortality_comp_temp_new_sizes_v3.png')
