...
load([dp 'Climatol_ensemble_LHS100_redux.mat']);
...
xlim([0.25 1])
ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_v2_redux.png'])
...
print('-dpng',[pp 'param_distr_best_v2_redux.png'])
...
print('-dpng',[pp 'param_distr_best_FD_redux.png'])
%%
for k=1:length(id3)
    M=id3(k);
    sfile = sim{M};
