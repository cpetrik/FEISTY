...
%writetable(T,[nfile 'LHS_param13_AIC.csv'])
...
writetable(cT,[nfile 'LHS_param13_AIC_classic.csv'])
...
writetable(bT,[nfile 'LHS_param13_AIC_builtin.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
%print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param13.png'])
...
print('-dpng',[pp 'param13_distr_best_AIC.png'])
...
print('-dpng',[pp 'param13_distr_best_AIC_redF.png'])
