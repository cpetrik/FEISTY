...
writetable(cT,[dp 'LHS_param5_mid5_AIC_Foutlier.csv'])
...
writetable(bT,[dp 'LHS_param5_mid5_AIC_builtin_Foutlier.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_mid5_bestAIC_params_Foutlier.csv'])
