...
%then mult by extra 1.5 because F still too low
mis_all_F2 = mis_all_F * (45/36) * 1.5;
...
writetable(cT,[dp 'LHS_param5_mid5_AIC_Foutlier_weighted15.csv'])
...
writetable(bT,[dp 'LHS_param5_mid5_AIC_builtin_Foutlier_weighted15.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_mid5_bestAIC_params_Foutlier_weighted15.csv'])
