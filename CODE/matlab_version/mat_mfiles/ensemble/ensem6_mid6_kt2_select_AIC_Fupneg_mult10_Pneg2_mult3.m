...
dp2 = '/Volumes/GFDL/NC/Matlab_new_size/param_ensemble/Dc_enc-k063_cmax20-b250-k063_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/';
...
%% vis best maps
bad = [429;248;409;578;427;411;471;407];
id1 = setdiff(pid,bad);
for j=1:length(id1)
    M=id1(j);
    sfile = sim{M};
...
save([dp 'LHS_param6_mid6_kt2_bestAIC_params_Fupneg_mult10_Pneg2_mult3_reduced.mat'],...
