...
load([dp 'Climatol_ensemble_param5_hi_low.mat']);
...
mis_combo = reshape(mis_all_fn,32,45*3);
...
%writetable(T,[nfile 'LHS_param5_hi_low_AIC.csv'])
...
writetable(cT,[nfile 'LHS_param5_hi_low_AIC_classic.csv'])
...
writetable(bT,[nfile 'LHS_param5_hi_low_AIC_builtin.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[nfile 'LHS_param5_hi_low_bestAIC_params.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low.png'])
...
print('-dpng',[pp 'param5_hi_lo_distr_best_AIC.png'])
...
print('-dpng',[pp 'param5_hi_lo_distr_best_AIC_redF.png'])
...
colormap('jet')
caxis([360 400])
print('-dpng',[pp 'param5_hi_lo_AIC_best_met.png'])
