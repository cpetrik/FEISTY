...
%% Square the F upwelling LME misfits so they weigh more
up = [3;11;13;27;28;29];
[uboth,uid,kid]=intersect(up,keep);

mis_all_F = mis_all(:,:,2);
mis_all_F2 = mis_all_F;
mis_all_F2(:,kid) = mis_all_F(:,kid) .^ 2;
...
writetable(cT,[dp 'LHS_param5_hi_low_mid_AIC_sqFup.csv'])
...
writetable(bT,[dp 'LHS_param5_hi_low_mid_AIC_builtin_sqFup.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_hi_low_mid_bestAIC_params_sqFup.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low_mid_sqFup.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_sqFup.png'])
...
colormap('jet')
caxis([369 386])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_sqFup.png'])
