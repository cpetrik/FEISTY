...
load([dp 'Climatol_ensemble_param5_hi_low_mid_GFW_v2.mat'],'rmse_all','mis_all','sim',...
...
%% SAU comparison
[r,rmse,ss,mis] = lme_saup_corr_stock_ensem_GFW_v2(lme_mcatch);
...
over = [16;31;34;37;38;20;21;59;60];
...
writetable(cT,[nfile 'LHS_param5_hi_low_mid_AIC_classic_GFW_v2.csv'])
...
writetable(bT,[nfile 'LHS_param5_hi_low_mid_AIC_builtin_GFW_v2.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[nfile 'LHS_param5_hi_low_mid_bestAIC_params_GFW_v2.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low_mid_GFW_v2.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_GFW_v2.png'])
...
colormap('jet')
caxis([330 360])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_GFW_v2.png'])
