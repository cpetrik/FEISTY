...
% param ensemble results with kt=0.06 and 0.1
load([dp 'Climatol_ensemble_param6_mid6_temp.mat'],'rmse_all','mis_all','sim',...
    'lme_Fmcatch','lme_Pmcatch','lme_Dmcatch');
rmse_all2 = rmse_all;
mis_all2 = mis_all;
sim2 = sim;
...
%%
rmse_all = [rmse_all1, rmse_all2];
mis_all = [mis_all1; mis_all2];
sim = [sim1; sim2];
lme_Fmcatch = [lme_Fmcatch1, lme_Fmcatch2];
lme_Pmcatch = [lme_Pmcatch1, lme_Pmcatch2];
lme_Dmcatch = [lme_Dmcatch1, lme_Dmcatch2];
...
load([nfile 'LHS_param6_mid6_temp.mat'],'fx','ptext');
...
writetable(cT,[dp 'LHS_param6_mid6_AIC_Fupneg_mult10_Pneg2_mult3.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','kMet','AIC'});
writetable(pT,[dp 'LHS_param6_mid6_bestAIC_params_Fupneg_mult10_Pneg2_mult3.csv'])

id1 = pid;

params = fx_all(pid,:);
save([dp 'LHS_param6_mid6_bestAIC_params_Fupneg_mult10_Pneg2_mult3.mat'],...
    'params','ptext','pid')
