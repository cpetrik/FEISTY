...
load([dp 'Climatol_ensemble_param5_hi_low_mid_GFW.mat'],'rmse_all','mis_all','sim',...
...
%% SAU comparison
[r,rmse,ss,mis] = lme_saup_corr_stock_ensem_GFW(lme_mcatch);
...
keep = notLELC;
%Drop LMEs with low F (seine) and high effort from GFW
over = [16;31;34;37;38]; %underpredicts 20;21;59;60 with high effort
...
writetable(cT,[nfile 'LHS_param5_hi_low_mid_AIC_classic_GFW.csv'])
...
writetable(bT,[nfile 'LHS_param5_hi_low_mid_AIC_builtin_GFW.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[nfile 'LHS_param5_hi_low_mid_bestAIC_params_GFW.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low_mid_GFW.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_GFW.png'])
...
colormap('jet')
caxis([350 375])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_GFW.png'])
