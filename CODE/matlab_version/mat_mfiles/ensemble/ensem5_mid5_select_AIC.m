...
mis_combo = reshape(mis_all_fn,length(fx_all),45*3);
...
writetable(cT,[nfile 'LHS_param5_mid5_AIC_classic.csv'])
...
writetable(bT,[nfile 'LHS_param5_mid5_AIC_builtin.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[nfile 'LHS_param5_mid5_bestAIC_params.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_mid5.png'])
