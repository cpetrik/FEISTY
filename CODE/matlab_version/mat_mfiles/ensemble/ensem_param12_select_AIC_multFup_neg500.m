...
load([dp 'LHS_param12_500vals.mat']);
...
mis_combo = [mis_all_F2,mis_all_P,mis_all_D];
...
writetable(cT,[nfile 'LHS500_param12_AIC_multFup_neg.csv'])
...
writetable(bT,[nfile 'LHS500_param12_AIC_multFup_neg.csv'])
...
writetable(pT,[nfile 'LHS500_param12_bestAIC_params_multFup_neg.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
%print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param12_multFup_neg500.png'])
...
%print('-dpng',[pp 'param12_distr_best_AIC_multFup_neg500.png'])
