...
dp = '/Volumes/FEISTY/NC/Matlab_new_size/param_ensemble/Dc_enc-k063_cmax20-b250-k063_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/';

%%
nfile = '/Volumes/FEISTY/NC/Matlab_new_size/param_ensemble/';
load([nfile 'LHS_param6_mid6_temp3.mat']);
...
for j = 1:length(fx)
    ...
    [fname,sname] = sub_fname_ensemble6();
    fsim{j} = fname;
    sim{j} = sname;
end
...
%%
save([dp 'Climatol_ensemble_param6_mid6_temp3.mat'],'SF','SP','SD',...
