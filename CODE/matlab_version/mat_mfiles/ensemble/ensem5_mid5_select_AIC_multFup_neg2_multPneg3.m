...
writetable(cT,[dp 'LHS_param5_mid5_AIC_multFup_neg2_multPneg3.csv'])
...
writetable(bT,[dp 'LHS_param5_mid5_AIC_builtin_multFup_neg2_multPneg3.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_mid5_bestAIC_params_multFup_neg2_multPneg3.csv'])

id1 = pid;

params = fx_all(pid,:);
save([dp 'LHS_param5_mid5_bestAIC_params_multFup_neg2_multPneg3.mat'],...
    'params','ptext','pid')
