...
mis_combo = reshape(mis_all_fn,length(fx2),45*3);
...
writetable(cT,[nfile 'LHS500_param12_AIC_classic.csv'])
...
writetable(bT,[nfile 'LHS500_param12_AIC_builtin.csv'])
...
writetable(pT,[nfile 'LHS500_param12_bestAIC_params.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
%print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param12_500.png'])
...
print('-dpng',[pp 'param12_distr_best_AIC_500.png'])
