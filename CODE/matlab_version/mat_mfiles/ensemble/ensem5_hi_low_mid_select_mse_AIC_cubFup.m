...
%% Cube the F upwelling LME misfits so they weigh more
up = [3;11;13;27;28;29];
[uboth,uid,kid]=intersect(up,keep);

mis_all_F = mis_all(:,:,2);
mis_all_F2 = mis_all_F;
mis_all_F2(:,kid) = mis_all_F(:,kid) .^ 3;
...
writetable(cT,[dp 'LHS_param5_hi_low_mid_AIC_cubFup.csv'])
...
writetable(bT,[dp 'LHS_param5_hi_low_mid_AIC_builtin_cubFup.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_hi_low_mid_bestAIC_params_cubFup.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low_mid_cubFup.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_cubFup.png'])
...
colormap('jet')
caxis([375 390])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_cubFup.png'])
