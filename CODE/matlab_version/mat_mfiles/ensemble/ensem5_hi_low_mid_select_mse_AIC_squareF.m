...
%% Square the F misfits so they weigh more
mis_all_F = mis_all(:,:,2);
mis_all_F2 = mis_all_F .^ 2;
...
writetable(cT,[dp 'LHS_param5_hi_low_mid_AIC_squareF.csv'])
...
writetable(bT,[dp 'LHS_param5_hi_low_mid_AIC_builtin_squareF.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_hi_low_mid_bestAIC_params_squareF.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param5_hi_low_mid_squareF.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_squareF.png'])
