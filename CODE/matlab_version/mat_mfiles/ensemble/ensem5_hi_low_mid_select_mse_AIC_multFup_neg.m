...
writetable(cT,[dp 'LHS_param5_hi_low_mid_AIC_multFup_neg.csv'])
...
writetable(bT,[dp 'LHS_param5_hi_low_mid_AIC_builtin_multFup_neg.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_hi_low_mid_bestAIC_params_multFup_neg.csv'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_multFup_neg.png'])
...
colormap('jet')
caxis([470 515])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_multFup_neg.png'])
