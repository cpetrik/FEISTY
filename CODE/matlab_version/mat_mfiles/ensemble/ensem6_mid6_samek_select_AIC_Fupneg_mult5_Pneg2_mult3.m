...
pp = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Figs/PNG/Matlab_New_sizes/',...
    'param_ensemble/',...
    'Dc_cmax20-b250_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/',...
    'bestAIC_params_Fupneg_mult5_Pneg2_mult3/'];
...
writetable(cT,[dp 'LHS_param6_mid6_samek_AIC_Fupneg_mult5_Pneg2_mult3.csv'])
...
% writetable(bT,[dp 'LHS_param6_mid6_samek_AIC_builtin_Fupneg_mult5_Pneg2_mult3.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    ...
    'rF','rP','rD'});
writetable(pT,[dp 'LHS_param6_mid6_samek_bestAIC_params_Fupneg_mult5_Pneg2_mult3.csv'])

id1 = pid;

params = fx(pid,:);
save([dp 'LHS_param6_mid6_samek_bestAIC_params_Fupneg_mult5_Pneg2_mult3.mat'],...
    'params','ptext2','pid')
