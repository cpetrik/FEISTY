% FEISTY full parameter sets of hi/low for 5
% then met params const, full set mid for other 3
...
load([dp 'Climatol_ensemble_param5_hi_low.mat'],'rmse_all');
rmse_all5 = rmse_all;
clear rmse_all

load([dp 'Climatol_ensemble_param5_hi_low_mid.mat'],'rmse_all');
rmse_all3 = rmse_all;
clear rmse_all
...
plow5 = plow;
phi5 = phi;
clear fx ptext plow phi

load([nfile 'LHS_param5_hi_low_mid.mat']);
fx3 = fx;
ptext3 = ptext;
plow3 = plow;
phi3 = phi;
...
% xlim([0.25 1])
% ylim([0 6])
print('-dpng',[pp 'RMSE_SAUP_type_best_param5_hi_low_mid.png'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best.png'])
...
%print('-dpng',[pp 'param5_hi_lo_mid_distr_best_FD.png'])
