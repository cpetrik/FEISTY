function vis_clim_lme_saup_corr_stock_upwell(lme_Fmcatch,lme_Pmcatch,lme_Dmcatch,ppath,simname)
...
%Only use Upwelling areas for F comps
up = [3;11;13;27;28;29];

% Stats
%r
[rall,pall]=corr(l10s(keep),l10p(keep));
[rF,pF]=corr(l10sF(up),l10pF(up));
...
scatter(l10sF(up),l10pF(up),20,lme_ptemp(up,1),'filled'); hold on;
cmocean('thermal');
...
title('All fishes')
stamp([harv '_' cfile])
print('-dpng',[ppath 'Clim_SAUP_comp_Stock_LELC_upwell_',simname,'.png'])
