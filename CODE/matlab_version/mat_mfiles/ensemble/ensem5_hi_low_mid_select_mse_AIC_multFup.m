...
%% Multiply the F upwelling LME misfits so they weigh more
up = [3;11;13;27;28;29];
[uboth,uid,kid]=intersect(up,keep);

mis_all_F = mis_all(:,:,2);
mis_all_F2 = mis_all_F;
mis_all_F2(:,kid) = mis_all_F(:,kid) .* 10;
...
writetable(cT,[dp 'LHS_param5_hi_low_mid_AIC_multFup.csv'])
...
writetable(bT,[dp 'LHS_param5_hi_low_mid_AIC_builtin_multFup.csv'])
...
pT = array2table(pset,'VariableNames',{'ParamSet','Lambda','bMet','bEnc',...
    'aMet','aEnc','AIC'});
writetable(pT,[dp 'LHS_param5_hi_low_mid_bestAIC_params_multFup.csv'])
...
print('-dpng',[pp 'param5_hi_lo_mid_distr_best_AIC_multFup.png'])
...
colormap('jet')
caxis([710 750])
print('-dpng',[pp 'param5_hi_lo_mid_AIC_best_met_multFup.png'])
