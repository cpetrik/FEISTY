...
load([dp 'Climatol_ensemble_param13_LHS100.mat'])
...
writetable(cT,[nfile 'LHS_param13_AIC_multFup_neg_multPneg.csv'])
...
writetable(bT,[nfile 'LHS_param13_AIC_multFup_neg_multPneg.csv'])
...
writetable(pT,[nfile 'LHS_param13_bestAIC_params_multFup_neg_multPneg.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
%print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param13_multFup_neg_multPneg.png'])
...
print('-dpng',[pp 'param13_distr_best_AIC_multFup_neg_multPneg.png'])
