...
load([nfile 'LHS_param12_100vals.mat']);
...
writetable(cT,[nfile 'LHS_param12_AIC_classic.csv'])
...
writetable(bT,[nfile 'LHS_param12_AIC_builtin.csv'])
...
writetable(pT,[nfile 'LHS_param12_bestAIC_params.csv'])
...
% xlim([0.25 1])
% ylim([0 6])
%print('-dpng',[pp 'RMSE_SAUP_type_best_AIC_param12.png'])
...
print('-dpng',[pp 'param12_distr_best_AIC.png'])
