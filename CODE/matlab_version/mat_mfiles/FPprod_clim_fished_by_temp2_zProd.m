...
vF = sf_mprod+mf_mprod;
vP = sp_mprod+mp_mprod+lp_mprod;
...
eF = sf_mprod+mf_mprod;
eP = sp_mprod+mp_mprod+lp_mprod;
...
save([fpath 'FPprod_zProd_temp2_clim_fits_' cfile '.mat'],'opred','epred');
...
print('-dpng',[pp 'Clim_',harv,'_FPprod_zProd_temp2_fits.png'])
