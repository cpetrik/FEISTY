...
load([cpath 'cobalt_hist9095_det_temp_zoop_means.mat']);
...
z_mean = mz_mean_hist9095 + lz_mean_hist9095;
z_loss = mzloss_mean_hist9095 + lzloss_mean_hist9095;
...
% m/m2/d --> total g; Mult flux by 365 - YES
Adet_mean = 365 * det_mean_hist9095 .* AREA_OCN;
...
for L=1:66
    ...
    lme_det(L) = nanmean(det_mean_hist9095(lid));
...
%%
save([cpath 'LME_hist9095_temp_zoop_det.mat'],'lme_ptemp','lme_btemp',...
...
title('Historic 1990-1994 LME mean temp 0-100 m (^oC)')
print('-dpng',[cpath 'Hist90-95_lme_Ptemp.png'])
...
ylim(hcb,[-2 30])                   %Set color axis if needed
set(gcf,'renderer','painters')
title('Historic 1990-1994 LME mean bottom temp (^oC)')
print('-dpng',[cpath 'Hist90-95_lme_Btemp.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Historic 1990-1994 LME mean zoop biomass 0-100 m (log10 g m^-^2)')
print('-dpng',[cpath 'Hist90-95_lme_zoop.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Historic 1990-1994 LME mean zoop loss 0-100 m (log10 g m^-^2 d^-^1)')
print('-dpng',[cpath 'Hist90-95_lme_zloss.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Historic 1990-1994 LME mean bottom detritus flux (log10 g m^-^2 d^-^1)')
print('-dpng',[cpath 'Hist90-95_lme_det.png'])
