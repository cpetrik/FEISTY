...
Fstat = array2table(fish_stat,'VariableNames',{'r','RMSE','p'},...
    ...
    'vanD Frac Pelagic','Maureaud TE'});
writetable(Fstat,[fpath 'US_LMEs_all_stats_' cfile '.csv'],'Delimiter',',',...
    'WriteRowNames',true)
save([fpath 'US_LMEs_all_stats_' cfile '.mat'],'fish_stat')
