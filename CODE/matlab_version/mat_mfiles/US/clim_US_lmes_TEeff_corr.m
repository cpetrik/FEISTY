...
writetable(T1,[spath 'US_LMEs_TEeff_Mauread_comp_' cfile '.csv'],'Delimiter',',')
save([dpath 'US_LMEs_TEeff_Mauread_comp_' cfile '.mat'],'tab','keep',...
    'mECI','pECI')
...
figure(1)
% FEISTY
subplot('Position',[0 0.53 0.45 0.5])
...
caxis([-2.8 -1.4]);
colorbar('Position',[0.075 0.575 0.34 0.025],'orientation','horizontal')                   
set(gcf,'renderer','painters')
%title('Climatology log_1_0 TEeff HTL')
text(-1.3,1.4,'A','FontSize',14)

% Maureaud
subplot('Position',[0.5 0.53 0.45 0.5])
axesm ('Mercator','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','off',...
    'Grid','off','FLineWidth',1)
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
caxis([-2.8 -1.4]);
colorbar('Position',[0.575 0.575 0.34 0.025],'orientation','horizontal')                  
set(gcf,'renderer','painters')
%title('Maureaud log_1_0 mean ECI 1991-1995')
text(-1.3,1.4,'B','FontSize',14)

% Diff
subplot('Position',[0.0 0.03 0.45 0.5])
axesm ('Mercator','MapLatLimit',latlim,'MapLonLimit',lonlim,'frame','off',...
    'Grid','off','FLineWidth',1)
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
caxis([-1 1]);
colorbar('Position',[0.1 0.075 0.34 0.025],'orientation','horizontal')              
set(gcf,'renderer','painters')
...
%stamp(cfile)
print('-dpng',[ppath 'Clim_' harv '_US_LME_TEeff_Maureaud_comp_subplot_temp.png'])
...
%Corr
subplot('Position',[0.575 0.08 0.4 0.4])
plot(x,x,'--k');hold on;
...
text(-2.9,-1.15,'D','FontSize',14)
%stamp(cfile)
print('-dpng',[ppath 'Clim_' harv '_US_LME_TEeff_Maureaud_comp_subplot_corr.png'])
