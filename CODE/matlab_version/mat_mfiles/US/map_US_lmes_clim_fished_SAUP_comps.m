...
caxis([-3.5 1.5]);
colorbar('Position',[0.44 0.575 0.025 0.34])                   
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
caxis([-3.5 1.5]);
colorbar('Position',[0.94 0.575 0.025 0.34])                   
set(gcf,'renderer','painters')
...
h=patchm(lat+0.5,long+0.5,'w','FaceColor',[0.75 0.75 0.75]);
caxis([-1 1]);
colorbar('Position',[0.44 0.075 0.025 0.34])                   
set(gcf,'renderer','painters')
...
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_F_SAUP_comp_subplot_corr.png'])
...
text(-4.75,0.5,'D','FontSize',14)
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_P_SAUP_comp_subplot_corr.png'])
...
%Corr
subplot('Position',[0.575 0.1 0.4 0.4])
plot(x,x,'--k');hold on;
...
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_D_SAUP_comp_subplot_corr.png'])
...
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_All_SAUP_comp_subplot_corr.png'])
...
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_PD_SAUP_comp_subplot_corr.png'])
...
print('-dpng',[ppath 'Clim_' harv '_US_LMEs_AllDiffs_SAUP_comp_subplot.png'])
