...
title('CORE')
stamp(cfile)
print('-dpng',[ppath 'CORE_fished_obs_all_sizes.png'])
...
ylabel('log10 Biomass (g m^-^2)')
title(['CORE'])
print('-dpng',[ppath 'CORE_fished_obs_all_types.png'])
...
stamp(cfile)
print('-dpng',[ppath 'CORE_fished_obs_global_BENT.png'])
...
stamp(cfile)
print('-dpng',[ppath 'CORE_fished_obs_global_All_subplot.png'])
...
stamp(cfile)
print('-dpng',[ppath 'CORE_fished_obs_global_ratios_subplot.png'])
