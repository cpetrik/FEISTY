...
% Only remapped LZ, but does it correctly - 19710101 
% (but 1972 & 1991 run on kelpfish 8/6/24 do not?)
% 1973 run on tunafish 8/7/24 correct
...
%% zmeso regular grid
ncdisp([fpath '19730101.ocean_cobalt_LZflux_int_FishMIP_CP_remapped.nc'])
...
%% 
ncid = netcdf.open([fpath '19730101.ocean_cobalt_LZflux_int_FishMIP_CP_remapped.nc'],'NC_NOWRITE');
