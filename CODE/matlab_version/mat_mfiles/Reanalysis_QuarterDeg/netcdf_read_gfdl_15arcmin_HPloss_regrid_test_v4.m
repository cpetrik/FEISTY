...
%% zmeso regular grid
ncdisp([fpath '19710101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'])
...
%% 
ncid = netcdf.open([fpath '19710101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'],'NC_NOWRITE');
...
test2 = double(squeeze(hploss_nmdz_100(:,:,6)));
...
figure(9)
pcolor(fliplr(test2)); shading flat; 
colorbar
clim([0 0.05])
title('HP MZ')
