...
%% zmeso regular grid
ncdisp([fpath '19970101.ocean_cobalt_tracers_month_z_FishMIP_remapped.nc'])
...
%% 
ncid = netcdf.open([fpath '19970101.ocean_cobalt_tracers_month_z_FishMIP_remapped.nc'],'NC_NOWRITE');
