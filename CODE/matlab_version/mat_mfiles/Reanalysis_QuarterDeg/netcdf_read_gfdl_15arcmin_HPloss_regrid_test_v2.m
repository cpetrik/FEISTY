...
% Code from Matthias. Does not fix arctic.
...
%% zmeso regular grid
ncdisp([fpath '20100101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'])
...
%% 
ncid = netcdf.open([fpath '20100101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'],'NC_NOWRITE');
