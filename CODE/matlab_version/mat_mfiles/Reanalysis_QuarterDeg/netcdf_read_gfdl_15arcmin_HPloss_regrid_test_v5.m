...
% Only remapped MZ, but does it correctly
...
%% zmeso regular grid
ncdisp([fpath '19910101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'])
...
%% 
ncid = netcdf.open([fpath '19910101.ocean_cobalt_fluxes_int_FishMIP_CP_remapped.nc'],'NC_NOWRITE');
