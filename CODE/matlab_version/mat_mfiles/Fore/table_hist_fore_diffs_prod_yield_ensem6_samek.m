...
% 5 most sens params and same k's
...
load([epath 'Prod_diff_50yr_ensem6_mid_samek_bestAIC_Fupneg_mult8_Pneg2_mult3.mat'])
...
%%
load([epath 'Hist_Fore_All_fish03_ensem6_mid_samek_yield_diff_pdiff.mat'],...
    'fbar','dbar','names')
% load([epath2 'Hist_Fore_All_fish03_ensem6_mid_samek_yield_diff_pdiff.mat'],...
%     'fbar','dbar','names')
...
%%
writetable(Ptab,[epath 'Hist_Fore_All_fish03_ensem6_mid_samek_prod_diff_pdiff_MeanStd.csv'],...
    'Delimiter',',','WriteRowNames',true)
writetable(Ptab,[epath2 'Hist_Fore_All_fish03_ensem6_mid_samek_prod_diff_pdiff_MeanStd.csv'],...
    'Delimiter',',','WriteRowNames',true)

writetable(Ytab,[epath 'Hist_Fore_All_fish03_ensem6_mid_samek_yield_diff_pdiff_MeanStd.csv'],...
    'Delimiter',',','WriteRowNames',true)
writetable(Ytab,[epath2 'Hist_Fore_All_fish03_ensem6_mid_samek_yield_diff_pdiff_MeanStd.csv'],...
    'Delimiter',',','WriteRowNames',true)
