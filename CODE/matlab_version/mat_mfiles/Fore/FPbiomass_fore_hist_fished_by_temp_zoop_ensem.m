...
%%
epred = nan*ones(26,4,length(params));
...
ylabel('fish biomass (g m^-^2)')
axis([0 25 0 20])
print('-dpng',[ppath 'Hist_Fore_',harv,'_FP_zoop_temp_scatter_',simname,'.png'])

end
%%
save([nfile 'FP_zoop_temp_hist_fore_fits_ens.mat'],'epred');
