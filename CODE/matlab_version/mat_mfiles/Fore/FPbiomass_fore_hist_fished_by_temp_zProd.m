...
save([fpath 'FP_zProd_temp_hist_fore_fits_' cfile '.mat'],'opred');

fpath2=['/Volumes/FEISTY/NC/Matlab_new_size/' cfile '/'];
save([fpath2 'FP_zProd_temp_hist_fore_fits_' cfile '.mat'],'opred');
...
print('-dpng',[pp 'Hist_Fore_',harv,'_FP_zProd_temp_scatter.png'])
