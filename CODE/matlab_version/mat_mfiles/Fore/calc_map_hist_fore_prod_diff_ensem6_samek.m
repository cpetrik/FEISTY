...
ppath = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Figs/PNG/',...
    ...
    'Dc_cmax20-b250_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/full_runs/'];
...
load([nfile 'simnames_ensem6_mid_samek_bestAIC_Fupneg_mult8_Pneg2_mult3.mat'])

pdF = nan(length(ID),length(snames));
pdP = pdF;
pdD = pdF;
pdA = pdF;
pdM = pdF;
...
nfile = ['/Volumes/FEISTY/NC/Matlab_new_size/param_ensemble/',...
    'Dc_cmax20-b250_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/'];
efile = ['/Users/cpetrik/Dropbox/Princeton/FEISTY/CODE/Data/',...
    'Dc_cmax20-b250_D075_J100_A050_Sm025_nmort1_BE075_noCC_RE00100_Ka050/'];
save([nfile 'Prod_diff_50yr_ensem6_mid_samek_bestAIC_Fupneg_mult8_Pneg2_mult3.mat'],...
    'pdF','pdP','pdD','pdA','pdM','pdL','pdBp','pdBb',...
    '-append');
save([efile 'Prod_diff_50yr_ensem6_mid_samek_bestAIC_Fupneg_mult8_Pneg2_mult3.mat'],...
    'pdF','pdP','pdD','pdA','pdM','pdL','pdBp','pdBb',...
    '-append');
...
text(-2.5,1.75,'H')
print('-dpng',[ppath 'Hist_Fore_',harv,'_global_pdiff_prod_samek_std_8plot.png'])
...
text(0,1.75,'All','HorizontalAlignment','center')
text(-2.5,1.75,'H')
print('-dpng',[ppath 'Hist_Fore_',harv,'_global_pdiff_prod_samek_agree_8plot.png'])
...
text(0,1.75,'All','HorizontalAlignment','center')
text(-2.5,1.75,'H')
print('-dpng',[ppath 'Hist_Fore_',harv,'_global_pdiff_prod_samek_std_agree_8plot.png'])