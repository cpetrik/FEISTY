% Visualize output of FEISTY Forecast at single locations
% 95 years, monthly means saved
...
%load('/Volumes/FEISTY/Data/Data_grid_hindcast_NOTflipped.mat');
...
save([dpath sname 'locs_' harv '_lastmo_mean_biom.mat'],...
