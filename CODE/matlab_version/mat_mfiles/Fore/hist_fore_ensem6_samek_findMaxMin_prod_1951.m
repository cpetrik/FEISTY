...
load([epath 'LHS_param6_mid6_samek_bestAIC_params_Fupneg_mult8_Pneg2_mult3.mat'],...
    'params','ptext2');
ptext = ptext2;
...
% Don't include orig params b/c don't have same k
% tF = [tF; tForig];
% tP = [tP; tPorig];
% tD = [tD; tDorig];
% tA = [tA; tAorig];
...
writetable(Stab,[epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_Var_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)
writetable(Stab,[epath2 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_Var_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)
...
pstats(1,2:7) = params(pstats(1,1),:);
pstats(2,2:7) = params(pstats(2,1),:);
pstats(3,2:7) = params(pstats(3,1),:);
pstats(4,2:7) = params(pstats(4,1),:);
pstats(5,2:7) = params(pstats(5,1),:);
pstats(6,2:7) = params(pstats(6,1),:);
pstats(7,2:7) = params(pstats(7,1),:);
pstats(8,2:7) = params(pstats(8,1),:);
% pstats(9,2:7)  = params(pstats(9,1),:);
% pstats(10,2:7) = params(pstats(10,1),:);
...
% writetable(Ttab,[epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinDiffs_prod.csv'],...
%     'Delimiter',',','WriteRowNames',true)
% writetable(Ttab,[dpath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinDiffs_prod.csv'],...
%     'Delimiter',',','WriteRowNames',true)
% 
% writetable(Ptab,[epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinDiffSims_prod.csv'],...
%     'Delimiter',',','WriteRowNames',true)
% writetable(Ptab,[dpath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinDiffSims_prod.csv'],...
%     'Delimiter',',','WriteRowNames',true)

%% save
save([epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_VarMaxMinDiffSims_prod.mat'],...
    'Stab','vstats','Ttab','tstats','Ptab','pstats');
save([epath2 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_VarMaxMinDiffSims_prod.mat'],...
    'Stab','vstats','Ttab','tstats','Ptab','pstats');
...
pdstat(1,2:7) = params(pdstat(1,1),:);
pdstat(2,2:7) = params(pdstat(2,1),:);
pdstat(3,2:7) = params(pdstat(3,1),:);
pdstat(4,2:7) = params(pdstat(4,1),:);
pdstat(5,2:7) = params(pdstat(5,1),:);
pdstat(6,2:7) = params(pdstat(6,1),:);
pdstat(7,2:7) = params(pdstat(7,1),:);
pdstat(8,2:7) = params(pdstat(8,1),:);
% pdstat(9,2:7)  = params(pdstat(9,1),:);
% pdstat(10,2:7) = params(pdstat(10,1),:);
...
writetable(Mtab,[epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinpPdiffs_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)
writetable(Mtab,[epath2 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinPdiffs_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)

writetable(Dtab,[epath 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinPdiffSims_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)
writetable(Dtab,[epath2 'Hist_Fore_',harv,'_ensem_mid6_samek_pset_MaxMinPdiffSims_prod.csv'],...
    'Delimiter',',','WriteRowNames',true)
...
title('All')
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_MaxMinAll_prod.png'])
...
ylabel('Change in production (g d^-^1) relative to 1951')
title('Forage fish')
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_MaxMinF_prod.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_MaxMinP_prod.png'])
...
ylabel('Change in production (g d^-^1) relative to 1951')
title('Demersal fish')
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_MaxMinD_prod.png'])
...
% ylabel('Change in production (g d^-^1) relative to 1951')
% title('Benthos')
% print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_MaxMinB_prod.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_max_ts_prod.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_min_ts_prod.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_max_ts_prod_pdiff.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_samek_min_ts_prod_pdiff.png'])
