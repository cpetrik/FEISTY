...
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_yield_all_ensem_mid6_samek_cone_1std_yr.png'])
...
xlabel('Year')
ylabel('Yield (MT km^-^2 y^-^1) relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_yield_adult_ensem_mid6_samek_cone_1std_yr.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_yield_all_ensem_mid6_samek_cone_1std_yr.png'])
...
xlabel('Year')
ylabel('Percent change in yield relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_yield_adult_ensem_mid6_samek_cone_1std_yr.png'])
...
xlabel('Year')
ylabel('Yield (MT km^-^2 y^-^1) relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_yield_types_all_ensem_mid6_samek_cone_1std_yr_v2.png'])
...
xlabel('Year')
ylabel('Yield (MT km^-^2 y^-^1) relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_yield_types_adults_ensem_mid6_samek_cone_1std_yr_v2.png'])
...
xlabel('Year')
ylabel('Percent change in yield relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_yield_types_all_ensem_mid6_samek_cone_1std_yr.png'])
...
xlabel('Year')
ylabel('Percent change in yield relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_yield_types_adults_ensem_mid6_samek_cone_1std_yr.png'])

%% save 
save([epath 'Hist_Fore_All_fish03_ensem6_mid_samek_ts_yield.mat'],...
...
save([epath2 'Hist_Fore_All_fish03_ensem6_mid_samek_ts_yield.mat'],...
    'Rf','Rp','Rd','Ra','Rlp','Rld','Raa',...
    'rmF','rmP','rmD','rmA','rmLP','rmLD','rmAA',...
    'dtF','dtP','dtD','dtA','dtLP','dtLD','dtAA',...
    'Vf','Vp','Vd','Va','Vlp','Vld','Vaa',...
