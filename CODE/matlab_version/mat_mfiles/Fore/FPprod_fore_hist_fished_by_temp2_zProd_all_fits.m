...
%load([fpath 'FPprod_zProd_temp2_hist_fore_fits_' cfile '.mat'],'opred');
load([fpath2 'FPprod_zProd_temp2_hist_fore_fits_' cfile '.mat'],'opred');
...
load([efile 'FPprod_zProd_temp2_hist_fore_fits_ens.mat'],'epred');
...
load([nfile 'FPprod_zProd_temp2_hist_fore_fits_ens_samek.mat'],'spred');
...
text(-4,-4,'Zooplankton production (g m^-^2 d^-^1)','HorizontalAlignment','center','FontWeight','bold')
text(-39,23,'Fish production (g m^-^2 d^-^1)','HorizontalAlignment','center','Rotation',90,'FontWeight','bold')
axis([0 3 0 0.4])
print('-dpng',[pp 'Hist_Fore_',harv,'_FPprod_zProd_temp2_fits_lines_v1.png'])
...
text(-39,23,'Fish production (g m^-^2 d^-^1)','HorizontalAlignment','center','Rotation',90,'FontWeight','bold')
axis([0 3 0 0.4])
print('-dpng',[pp 'Hist_Fore_',harv,'_FPprod_zProd_temp2_fits_lines_v2.png'])
...
axis([0 3 0 0.4])
text(-0.5,-0.075,'Zooplankton production (g m^-^2 d^-^1)','HorizontalAlignment','center','FontWeight','bold')
text(-4.75,0.5,'Fish production (g m^-^2 d^-^1)','HorizontalAlignment','center','Rotation',90,'FontWeight','bold')

print('-dpng',[pp 'Hist_Fore_',harv,'_FPprod_zProd_temp2_fits_cone.png'])
