...
%%
spred = nan*ones(13,4,length(params));
for j = 1:length(params)
    ...
    ylabel('fish production (g m^-^2 d^-^1)')
    axis([0 3 0 0.4])
    %print('-dpng',[pp 'Hist_Fore_',harv,'_FPprod_zProd_temp2_scatter_',simname,'.png'])
    
end

save([nfile 'FPprod_zProd_temp2_hist_fore_fits_ens_samek.mat'],'spred');
