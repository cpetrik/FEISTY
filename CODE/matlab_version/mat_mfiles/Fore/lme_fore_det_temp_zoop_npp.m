...
Adet_mean = 365 * det_mean_fore .* AREA_OCN;
Anpp_mean = 365 * npp_mean_fore .* AREA_OCN; 
...
for L=1:66
    ...
    lme_det(L) = nanmean(det_mean_fore(lid));
    lme_npp(L) = nanmean(npp_mean_fore(lid));
...
%%
save([cpath 'LME_fore_temp_zoop_det_npp.mat'],'lme_ptemp','lme_btemp',...
    'lme_z','lme_zl','lme_det','lme_az','lme_azl','lme_adet',...
    'lme_asz','lme_aszl','lme_asdet','lme_area','lme_npp','lme_anpp','lme_asnpp');
...
%print('-dpng',[cpath 'Fore_lme_Ptemp.png'])
...
%print('-dpng',[cpath 'Fore_lme_Btemp.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Forecast 2051-2100 LME mean zoop biomass 0-100 m (log10 g m^-^2)')
%print('-dpng',[cpath 'Fore_lme_zoop.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Forecast 2051-2100 LME mean zoop loss 0-100 m (log10 g m^-^2 d^-^1)')
%print('-dpng',[cpath 'Fore_lme_zloss.png'])
...
hcb = colorbar('h');
set(gcf,'renderer','painters')
title('Forecast 2051-2100 LME mean bottom detritus flux (log10 g m^-^2 d^-^1)')
%print('-dpng',[cpath 'Fore_lme_det.png'])
