...
assim = repmat(pdstat(:,2),1,3);
bpow  = repmat(pdstat(:,3),1,3);
benc  = repmat(pdstat(:,4),1,3);
amet  = repmat(pdstat(:,5),1,3);
gam   = repmat(pdstat(:,6),1,3);
kt    = repmat(pdstat(:,7),1,3);
...
set(gca,'XTickLabel',texp)
ylabel('L met scaled')
print('-dpng',[ppath 'Scaled_nu_met_MaxMin_pDiffSims_prod.png'])
...
% assim = repmat(pdstat(:,2),1,length(Preys));
% bpow  = repmat(pdstat(:,3),1,length(Preys));
% benc  = repmat(pdstat(:,4),1,length(Preys));
% amet  = repmat(pdstat(:,5),1,length(Preys));
% gam   = repmat(pdstat(:,6),1,length(Preys));
% kt    = repmat(pdstat(:,7),1,length(Preys));

assim = repmat(pdstat(:,2),1,length(Temps));
bpow  = repmat(pdstat(:,3),1,length(Temps));
benc  = repmat(pdstat(:,4),1,length(Temps));
amet  = repmat(pdstat(:,5),1,length(Temps));
gam   = repmat(pdstat(:,6),1,length(Temps));
kt    = repmat(pdstat(:,7),1,length(Temps));
...
caxis([0 0.6])
title('L min All')
print('-dpng',[ppath 'Scaled_nu_MaxMin_pDiffSims_prod_All.png'])
...
caxis([0 0.6])
title('L min F')
print('-dpng',[ppath 'Scaled_nu_MaxMin_pDiffSims_prod_F.png'])
...
caxis([0 0.6])
title('L min P')
print('-dpng',[ppath 'Scaled_nu_MaxMin_pDiffSims_prod_P.png'])
...
caxis([0 0.6])
title('L min D')
print('-dpng',[ppath 'Scaled_nu_MaxMin_pDiffSims_prod_D.png'])
...
caxis([0 0.6])
title('L min B')
print('-dpng',[ppath 'Scaled_nu_MaxMin_pDiffSims_prod_B.png'])
