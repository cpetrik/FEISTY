...
load([nfile 'Historic_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
    'haTsF','haTsP','haTsD','haTmF','haTmP','haTmD','haTB','haTlP','haTlD');
load([nfile 'Forecast_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_prod_all_ensem_mid6_samek_cone_1std_yr.png'])

%% all w/uncert - pdiff
figure(2)
f=fill(X,100*(Va),'k','FaceAlpha',0.25,'EdgeAlpha',0.25);  %plot filled area
hold on
plot(y,100*(mpA),'k','LineWidth',2);
xlim([y(yid) y(end)])
% ylim([0.425 0.675])
title('All fish')
xlabel('Year')
ylabel('Percent change in production relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_prod_all_ensem_mid6_samek_cone_1std_yr.png'])
...
xlabel('Year')
ylabel('Production (g d^-^1) relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_diff1951_prod_types_ensem_mid6_samek_cone_1std_yr_v2.png'])
...
xlabel('Year')
ylabel('Percent change in production relative to 1951')
print('-dpng',[ppath 'Hist_Fore_',harv,'_pdiff1951_prod_types_ensem_mid6_samek_cone_1std_yr.png'])

%% save for multipanel plot w/biom changes
save([nfile 'Hist_Fore_All_fish03_ensem6_mid_samek_ts_prod.mat'],...
    'Sf','Sp','Sd','Sa','mF','mP','mD','mA','dtF','dtP','dtD','dtA',...
    'Vf','Vp','Vd','Va','mpF','mpP','mpD','mpA','X','y');
save([dfile 'Hist_Fore_All_fish03_ensem6_mid_samek_ts_prod.mat'],...
    'Sf','Sp','Sd','Sa','mF','mP','mD','mA','dtF','dtP','dtD','dtA',...
    'Vf','Vp','Vd','Va','mpF','mpP','mpD','mpA','X','y');
