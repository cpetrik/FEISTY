...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_maxF.png'])
...
title('min \Delta Prod F')
axis([-0.15 0.25 -0.065 0.06])
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_minF.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_maxP.png'])
...
title('min \Delta Prod P')
axis([-0.3 0.5 -0.05 0.02])
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_minP.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_maxD.png'])
...
title('min \Delta Prod D')
axis([-0.07 0.08 -0.015 0.01])
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_nucmax_vs_prod_minD.png'])

%%
subplot(3,2,1)
scatter(ptemp_hist, hPmF(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
subplot(3,2,2)
scatter(ptemp_fore, fPmF(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
subplot(3,2,3)
scatter(ptemp_hist, hPlP(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
subplot(3,2,4)
scatter(ptemp_fore, fPlP(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
subplot(3,2,5)
scatter(btemp_hist, hPlD(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
subplot(3,2,6)
scatter(btemp_fore, fPlD(:,nd), 10,'k','filled')
% cmocean('thermal')
% colorbar
% caxis([0 30])
xlabel('temp')
...
%title('Fore')
axis([-5 35 0 0.035])
print('-dpng',[ppath 'Hist_Fore_',harv,'_ensem_mid6_temp3_prod_vs_temp.png'])
