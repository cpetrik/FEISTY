...
%load([fpath 'FP_zProd_temp2_hist_fore_fits_' cfile '.mat'],'opred');
load([fpath2 'FP_zProd_temp2_hist_fore_fits_' cfile '.mat'],'opred');
...
load([efile 'FP_zProd_temp2_hist_fore_fits_ens.mat'],'epred');
...
load([nfile 'FP_zProd_temp2_hist_fore_fits_ens_samek.mat'],'spred');
...
axis([0 3 0 20])
print('-dpng',[pp 'Hist_Fore_',harv,'_FP_zProd_temp2_fits_lines_v1.png'])
...
text(-39,23,'Fish biomass (g m^-^2)','HorizontalAlignment','center','Rotation',90,'FontWeight','bold')
axis([0 3 0 20])
print('-dpng',[pp 'Hist_Fore_',harv,'_FP_zProd_temp2_fits_lines_v2.png'])
...
print('-dpng',[pp 'Hist_Fore_',harv,'_FP_zProd_temp2_fits_cone.png'])
