...
%% save
save([epath 'TEeff_Det_Zprod_5yr_means_Hist_Fore_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
    'L','mdet','mmz_prod','mlz_prod','mnpp','y',...
    'TEeff_ATL','TEeff_LTL','TEeff_HTL','eTE_ATL','eTE_HTL',...
    'eTEeff_ATL','eTEeff_HTL');
save([epath2 'TEeff_Det_Zprod_5yr_means_Hist_Fore_All_fish03_ensem6_mid_samek_bestAIC_multFup_multPneg.mat'],...
    'L','mdet','mmz_prod','mlz_prod','mnpp','y',...
    'TEeff_ATL','TEeff_LTL','TEeff_HTL','eTE_ATL','eTE_HTL',...
    'eTEeff_ATL','eTEeff_HTL');

% load([epath 'TEeff_Det_Zprod_5yr_means_Hist_Fore_All_fish03_ensem6_mid_temp3_bestAIC_multFup_multPneg.mat']);
...
xlim([1951 2095])
xlabel('Year')
print('-dpng',[ppath 'Hist_Fore_',harv,'_TEeff_Det_Zprod_sub_ensem_samek.png'])
...
xlim([1951 2095])
xlabel('Year')
print('-dpng',[ppath 'Hist_Fore_',harv,'_TE_Det_Zprod_sub_ensem_samek.png'])
...
xlim([1951 2095])
xlabel('Year')
print('-dpng',[ppath 'Hist_Fore_',harv,'_TE_Det_Zprod_sub2_ensem_samek.png'])
...
xlim([1950 2095])
xlabel('Year')
print('-dpng',[ppath 'Hist_Fore_',harv,'_TE_Det_Zprod_d1951_cone_1std_ensem_samek_BW.png'])
...
xlim([1951 2095])
xlabel('Year')
print('-dpng',[ppath 'Hist_Fore_',harv,'_TE_Det_Zprod_d1951_cone_1std_ensem_samek_color.png'])
...
print('-dpng',[ppath 'Hist_Fore_',harv,'_TE_Det_Zprod_d1951_cone_1std_ensem_samek_color2.png'])
