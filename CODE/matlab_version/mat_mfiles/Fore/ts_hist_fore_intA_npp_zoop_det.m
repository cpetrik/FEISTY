...
h1 = axes('Units','pixels','Position',axesPosition,...
          ...
          'XLim',xLimit,'YLim',[2.5 2.9],'NextPlot','add');
h2 = axes('Units','pixels','Position',axesPosition+yWidth.*[-1 0 1 0],...
          'Color','none','XColor','k','YColor',cmap_ppt(1,:),...
          'XLim',xLimit+[xOffset 0],'YLim',[4.7 5.1],...
          'XTick',[],'XTickLabel',[],'NextPlot','add');
h3 = axes('Units','pixels','Position',axesPosition+yWidth.*[-2 0 2 0],...
          'Color','none','XColor','k','YColor',cmap_ppt(2,:),...
          'XLim',xLimit+[2*xOffset 0],'YLim',[1.7 2.1],...
          'XTick',[],'XTickLabel',[],'NextPlot','add');
xlabel(h1,'Year');
%ylabel(h3,'values');
...
% xlim([1895 2095])
%xlabel('Year')
text(1877,2.13,'Z:D','color',cm{6});
text(1847,2.13,'Z','color',cmap_ppt(1,:));
text(1817,2.13,'D','color',cmap_ppt(2,:));
