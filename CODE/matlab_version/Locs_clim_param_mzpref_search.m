...
function Locs_clim_param_mzpref_search()
...
global tstep K frate kc ke MZpref
...
for k=1:length(mzp)
    ...
    make_parameters_mzpref(MZpref)
    fname = sub_fname_mzpref_search(frate);
    ...
    S_Sml_f = NaN*ones(12,26,NX);
    S_Sml_p = NaN*ones(12,26,NX);
    S_Sml_d = NaN*ones(12,26,NX);
    S_Med_f = NaN*ones(12,26,NX);
    S_Med_p = NaN*ones(12,26,NX);
    S_Med_d = NaN*ones(12,26,NX);
    S_Lrg_p = NaN*ones(12,26,NX);
    S_Lrg_d = NaN*ones(12,26,NX);
    S_Cobalt = NaN*ones(12,5,NX);
