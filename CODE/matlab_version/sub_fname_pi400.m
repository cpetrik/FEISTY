%%%% File naming system
function fname = sub_fname_pi400(frate)
...
if (frate==0)
    fname = ['/Volumes/MIP/NC/Matlab_new_size/',simname, '/Pre400'];
elseif (Jsel~=0.1)
    fname = ['/Volumes/MIP/NC/Matlab_new_size/',simname, '/Pre400_', sel,'_fish',tfish(2:end),'_Juve',tJ(2:end)];
elseif (MFsel~=LPsel)
    fname = ['/Volumes/MIP/NC/Matlab_new_size/',simname, '/Pre400_fish_F',tF(2:end),'_P',tP(2:end),'_D',tD(2:end)];
else
    fname  = ['/Volumes/MIP/NC/Matlab_new_size/',simname, '/Pre400_', sel,'_fish',tfish(2:end)];  
end
