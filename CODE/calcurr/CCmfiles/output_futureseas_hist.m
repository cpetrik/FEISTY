...
for k=1:3
    ...
    %%
    load([fpath 'Means_Hist_' vers '_' harv '_' cfile '.mat'],'mSF','mMF')
    load([fpath 'Means_Hist_' vers '_' harv '_prod_' cfile '.mat'],'ympSF','ympMF')
    load([fpath 'Means_Hist_' vers '_' harv '_rec_' cfile '.mat'],'ysrMF')
    load([fpath 'Means_Hist_' vers '_' harv '_mort_' cfile '.mat'],'ysdSF','ysdMF')
    load([fpath 'Means_Hist_' vers '_' harv '_catch_' cfile '.mat'],'ytcMF')
