...
%% grid info
Cdir = '/Volumes/petrik-lab/Feisty/GCM_Data/NEMURO/HADdown/';

% Depth, lat, lon
load([Cdir 'feisty_hadley_gridspec.mat']);
load([Cdir 'Data_grid_nemuro_hadley.mat']);
...
%% temp scaling
load([Cdir 'feisty_hadley_tp_1980-2100.mat']);
load([Cdir 'feisty_hadley_tb_1980-2100.mat']);
...
%% save
save([Cdir 'nemuro_hadley_fmort_ID_annual_1980_2010_tempSc_',alt1,'.mat'],'year','WID',...
    'fmD','fmF','fmP');

Cdir2 ='/Volumes/petrik-lab/Feisty/GCM_Data/NEMURO/HADdown/';
save([Cdir2 'nemuro_hadley_fmort_ID_annual_1980_2010_tempSc_',alt1,'.mat'],'year','WID',...
    'fmD','fmF','fmP');
