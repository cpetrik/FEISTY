...
title('Future biomass')
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_all_sizes_biom.png'])
...
title('Future biomass')
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_all_types_biom.png'])
...
title('Future catch')
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_all_types_catch.png'])
...
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_BENT.png'])
...
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_All_subplot.png'])
...
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_ratios_subplot.png'])
...
text(0,0.93,'\bf log_1_0 mean All fishes (g m^-^2)','HorizontalAlignment','center')
stamp(vers)
print('-dpng',[ppath 'Project_' vers '_' harv '_All_catch_subplot.png'])
