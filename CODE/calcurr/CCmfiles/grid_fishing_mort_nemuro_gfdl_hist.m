...
load([Cdir 'Data_grid_nemuro_gfdl.mat']);
...
%% temp scaling
load([Cdir 'feisty_gfdl_tp_1980-2100.mat']);
load([Cdir 'feisty_gfdl_tb_1980-2100.mat']);
...
%% save
save([Cdir 'nemuro_gfdl_fmort_ID_annual_1980_2010_tempSc_',alt1,'.mat'],'year','WID',...
    'fmD','fmF','fmP');

Cdir2 ='/Volumes/petrik-lab/Feisty/GCM_Data/NEMURO/GFDLdown/';
save([Cdir2 'nemuro_gfdl_fmort_ID_annual_1980_2010_tempSc_',alt1,'.mat'],'year','WID',...
    'fmD','fmF','fmP');
