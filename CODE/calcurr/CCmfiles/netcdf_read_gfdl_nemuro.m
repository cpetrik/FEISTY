...
ncdisp([fpath 'feisty_gfdl_1980-2100.nc'])
...
pon_units       = 'mmolN/m3';
% history       = 'From /data01/fiechter/WC12_OffBio/GFDL_TV_1980-2100/Monthly/wc12_avg_1980.nc'
...
%%
ncid = netcdf.open([fpath 'feisty_gfdl_1980-2100.nc'],'NC_NOWRITE');
...
%%
save([fpath 'feisty_gfdl_gridspec.mat'],'BATHY','bathy_units',...
    'bathy_long_name','TMO','TMO_bnds',...
    'tmo_units','tmo_time_origin','tmo_standard_name','LAT','LON');

save([fpath 'feisty_gfdl_lzoo_1980-2100.mat'],'LZOO_INT_200M',...
    'lz_long_name','lz_units',...
    'TMO','TMO_bnds','tmo_units',...
    'tmo_time_origin','tmo_standard_name','LAT','LON');

save([fpath 'feisty_gfdl_pon_1980-2100.mat'],'PON_BOT',...
    'pon_long_name','pon_units',...
    'TMO','TMO_bnds','tmo_units',...
    'tmo_time_origin','tmo_standard_name','LAT','LON');

save([fpath 'feisty_gfdl_pzoo_1980-2100.mat'],'PZOO_INT_200M',...
    'pz_long_name','pz_units',...
    'TMO','TMO_bnds','tmo_units',...
    'tmo_time_origin','tmo_standard_name','LAT','LON');

save([fpath 'feisty_gfdl_tb_1980-2100.mat'],'TEMP_BOT','tb_long_name',...
    'TMO','TMO_bnds','tmo_units',...
    'tmo_time_origin','tmo_standard_name','LAT','LON','tb_units');

save([fpath 'feisty_gfdl_tp_1980-2100.mat'],'TEMP_AVG_200M',...
