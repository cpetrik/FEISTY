...
% make 2D
nuSf = sub_1Dto2D(GRD,Sf.nu,param);
nuSp = sub_1Dto2D(GRD,Sp.nu,param);
nuSd = sub_1Dto2D(GRD,Sd.nu,param);
nuMf = sub_1Dto2D(GRD,Mf.nu,param);
nuMp = sub_1Dto2D(GRD,Mp.nu,param);
nuMd = sub_1Dto2D(GRD,Md.nu,param);
nuLp = sub_1Dto2D(GRD,Lp.nu,param);
nuLd = sub_1Dto2D(GRD,Ld.nu,param);
...
% move
bioSf = AdvectPredator(bioSf,nuSf,current,param.adt,param.dx,param.dy,neighbor,param.U_s,param.mask,param.area,param.nj,param.ni);
bioSp = AdvectPredator(bioSp,nuSp,current,param.adt,param.dx,param.dy,neighbor,param.U_s,param.mask,param.area,param.nj,param.ni);
bioSd = AdvectPredator(bioSd,nuSd,current,param.adt,param.dx,param.dy,neighbor,param.U_s,param.mask,param.area,param.nj,param.ni);
bioMf = AdvectPredator(bioMf,nuMf,current,param.adt,param.dx,param.dy,neighbor,param.U_m,param.mask,param.area,param.nj,param.ni);
bioMp = AdvectPredator(bioMp,nuMp,current,param.adt,param.dx,param.dy,neighbor,param.U_m,param.mask,param.area,param.nj,param.ni);
bioMd = AdvectPredator(bioMd,nuMd,current,param.adt,param.dx,param.dy,neighbor,param.U_m,param.mask,param.area,param.nj,param.ni);
bioLp = AdvectPredator(bioLp,nuLp,current,param.adt,param.dx,param.dy,neighbor,param.U_l,param.mask,param.area,param.nj,param.ni);
bioLd = AdvectPredator(bioLd,nuLd,current,param.adt,param.dx,param.dy,neighbor,param.U_l,param.mask,param.area,param.nj,param.ni);
