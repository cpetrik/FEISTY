...
%============= PARAMETER TYPE ==========%
function param = const_params6_samek(param)
    ...
    %param.kc = 0.063;     % coeff on cmax T-dep fn 
    %param.ke = 0.063;     % coeff on enc T-dep fn 
    %param.kt = 0.0855;    % coeff on met T-dep fn (orig 0.063)
