...
load('/Volume/GCM_data/GFDL/ESM2.6/ESM26_1deg_5yr_clim_191_195_daily.mat','COBALT');
...
load('/Volume/GCM_data/GFDL/ESM2.6/ESM26_1deg_5yr_clim_191_195_grid.mat','GRD');
NX = length(GRD.Z);
ID = 1:NX;
param.NX = NX;
param.ID = ID;
