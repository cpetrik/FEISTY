...
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,ENVR] = sub_futbio_1meso_empHPloss(ID,DY,COBALT,GRD,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,param)
...
%%% COBALT information
ENVR = get_COBALT_1meso_empHPloss(COBALT,GRD,ID,DY);
