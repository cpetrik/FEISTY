% Pippa Edwards POC flux at 100 m
...
ncdisp([epath 'estpocbayes_poc_100_mapped.nc'])
...
%% POC flux 100 m
ncid = netcdf.open([epath 'estpocbayes_poc_100_mapped.nc'],'NC_NOWRITE');
...
%% save
save([epath 'estpocbayes_poc_100_mapped.mat'],'date','date_units','date_calendar','yr',...
