...
%%
epath = '/Volumes/petrik-lab/Feisty/Globus_RO/export_obs_products/NEP_regrid/';

ppath = '/Users/cpetrik/Petrik Lab Group Dropbox/Colleen Petrik/OCB_BGC/export_flux/Edwards/';

ncdisp([epath 'nep_estpocbayes_poc_SF100_mapped.nc'])
...
%% POC flux seafloor
ncid = netcdf.open([epath 'nep_estpocbayes_poc_SF100_mapped.nc'],'NC_NOWRITE');
...
stamp('')
print('-dpng',[ppath 'nep_meanlogpoc_SF100_mean.png'])

%% save
apath = '/Volumes/petrik-lab/Feisty/GCM_Data/MOM6-NEP10/';
save([apath 'nep_estpocbayes_poc_SF100_mapped.mat'],'date','date_units','date_calendar','yr',...
