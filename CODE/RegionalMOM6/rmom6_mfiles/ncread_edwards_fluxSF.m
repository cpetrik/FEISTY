...
%% POC flux seafloor
ncid = netcdf.open([epath 'estpocbayes_poc_SF_mapped.nc'],'NC_NOWRITE');
...
stamp('')
print('-dpng',[ppath 'meanlogpoc_SF_mean.png'])

%% save
save([epath 'estpocbayes_poc_SF_mapped.mat'],'date','date_units','date_calendar','yr',...
