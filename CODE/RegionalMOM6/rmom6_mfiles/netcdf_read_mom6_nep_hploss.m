...
%% zmeso
ncdisp([fpath 'jhploss_nmdz_100.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'])

ncdisp([fpath 'jhploss_nlgz_100.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'])
...
%% medium
ncid = netcdf.open([fpath 'jhploss_nmdz_100.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'],'NC_NOWRITE');
...
%% large
ncid = netcdf.open([fpath 'jhploss_nlgz_100.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
...
%%
save([fpath 'jhploss_mdz_lgz_100.nep.full.hcast.monthly.raw.r20250912.199301-202506.mat'],...
    '-v7.3');
