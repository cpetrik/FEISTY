...
%% one file
ncdisp([fpath 'btm_temp.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'])
...
%%
ncid = netcdf.open([fpath 'btm_temp.nep.full.hcast.monthly.raw.r20250912.199301-202506.nc'],'NC_NOWRITE');
...
%%
save([fpath 'btm_temp.nep.full.hcast.monthly.raw.r20250912.199301-202506.mat'], '-v7.3');
