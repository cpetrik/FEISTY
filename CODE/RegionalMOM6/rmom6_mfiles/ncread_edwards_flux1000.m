...
ncdisp([epath 'estpocbayes_poc_1000_mapped.nc'])
...
%% POC flux 1000 m
ncid = netcdf.open([epath 'estpocbayes_poc_1000_mapped.nc'],'NC_NOWRITE');
...
%clim([-3 0]);
hcb = colorbar('h');
title('log10 mean POC flux at 1000 m (mg/m2/day)')
stamp('')
print('-dpng',[ppath 'meanlogpoc_1000m_test.png'])
...
clim([2 5]);
hcb = colorbar('h');
title('log10 mean POC flux at 1000 m (mg/m2/day) 1997-2022')
stamp('')
print('-dpng',[ppath 'meanlogpoc_1000m_mean.png'])

%% save
save([epath 'estpocbayes_poc_1000_mapped.mat'],'date','date_units','date_calendar','yr',...
