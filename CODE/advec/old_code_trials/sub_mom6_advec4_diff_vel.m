function Tracer = sub_mom6_advec4_diff_vel(GRD,Tracer,K,uvel,vvel,ni,nj,tstep)
...
%when j=1, really jsd-2
%when j=2, really jsd-1
%when j=3, really jsd
%Only the first 1 latitude is Antarctic land, so keep at zero
