function [Flux] = semiLagrangFish(conc_matrix, Flux, idx, dir, current, dt, dx_m, dy_m, neighbors, grid_mask, area)
%% semiLagrangFish.m
% -------------------------------------------------------------------------
...
% DATE  : 30-06-2025
%
% Updated to change it so ff there are no higher concentrations of prey, are NOT advected with the current. 
% fish will stay where they are. If the grid cells have equal prey, the fish desire to move is zero.
% CMP 09-08-25
%
% -------------------------------------------------------------------------
    % Directions matrix
