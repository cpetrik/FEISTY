...
function Historic_gfdl_move_enc_spin20IC()
...
file_sml_f = [fname,'_spin20IC_sml_f.nc'];
file_sml_p = [fname,'_spin20IC_sml_p.nc'];
file_sml_d = [fname,'_spin20IC_sml_d.nc'];
file_med_f = [fname,'_spin20IC_med_f.nc'];
file_med_p = [fname,'_spin20IC_med_p.nc'];
file_med_d = [fname,'_spin20IC_med_d.nc'];
file_lrg_p = [fname,'_spin20IC_lrg_p.nc'];
file_lrg_d = [fname,'_spin20IC_lrg_d.nc'];
file_bent  = [fname,'_spin20IC_bent.nc'];
...
for YR = 1:nYEARS % years
    ...
    for DAY = 1:param.DT:DAYS % days
        ...
        [Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,ENVR] = ...
            sub_futbio_move_enc(DY,COBALT,GRD1,Sml_f,Sml_p,Sml_d,...
