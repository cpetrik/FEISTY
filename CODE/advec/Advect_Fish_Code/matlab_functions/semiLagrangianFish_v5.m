function [Flux] = semiLagrangianFish_v5(conc_matrix, Flux, idx, dir, current, dt, dx_m, dy_m, neighbors, grid_mask, area)
...
% -------------------------------------------------------------------------
    ...
    if totalDirections == 0
        %Flux = passiveSemiLagrangianFish_v5(conc_matrix, Flux, idx, dir, current, dt, dx_m, dy_m, neighbors, grid_mask, area);
        return;
    end
