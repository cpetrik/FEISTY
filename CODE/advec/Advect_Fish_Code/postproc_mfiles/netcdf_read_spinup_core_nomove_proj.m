...
%% Save mean of last year for initializing hindcast runs
...
BENT.bio  = mean(Bent.bio(:,lyr),2,'omitnan');

save([fpath 'Last_yrmean_' exper '_All_fish03_' cfile '.mat'],'Sml_f','Sml_p','Sml_d',...
    'Med_f','Med_p','Med_d','Lrg_p','Lrg_d','BENT')
