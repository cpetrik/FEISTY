function [ Flux ] = moveFishBehave( Predator, Flux, Prey, apparent_current_full, idx, neighbors, dt, dx_m, dy_m, grid_mask, area )
...
Flux = semiLagrangFish( Predator, Flux, [i,j], food_dir, ...
