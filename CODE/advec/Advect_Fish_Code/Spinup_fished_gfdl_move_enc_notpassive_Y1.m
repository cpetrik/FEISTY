...
function Spinup_fished_gfdl_move_enc_notpassive_Y1()
...
exper = 'Spinup1988_move_prey_v22_notpassive_dt6h';
...
for YR = 1:YEARS % years
    ...
    for DAY = 1:param.DT:DAYS % days
        ...
        [Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,ENVR] = ...
            sub_futbio_move_enc_notpassive(DY,COBALT,GRD1,Sml_f,Sml_p,Sml_d,...
