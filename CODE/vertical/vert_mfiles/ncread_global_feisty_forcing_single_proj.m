...
%%
%ncdisp([fpath '19940101.ocean_cobalt_feisty_forcing_z.nc'])
%ncdisp([fpath '19940101.ocean_cobalt_feisty_forcing_2d.nc'])

%%
nt=12;

%% 3D
ncid = netcdf.open([fpath '19940101.ocean_cobalt_feisty_forcing_z.nc'],'NC_NOWRITE');
...
%% Btm
ncid = netcdf.open([fpath '19940101.ocean_cobalt_feisty_forcing_2d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 5:6
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%%
save([spath 'ocean_cobalt_feisty_forcing_1994_means.mat'],...
