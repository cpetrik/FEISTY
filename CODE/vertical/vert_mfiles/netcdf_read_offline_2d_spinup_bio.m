...
%fpath=['/Volumes/petrik-lab/Feisty/NC/Matlab_new_size/' cfile '/COBALTv3_Hindcast_HalfDeg/'];
fpath=['/project/Feisty/NC/Matlab_new_size/' cfile '/COBALTv3_Hindcast_HalfDeg/'];
