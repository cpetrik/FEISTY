...
%% Diffs Online - Offline / Offline

dtDE = 100*(NtDE - FtDE) ./ FtDE;
dtMZ = 100*(NtMZ - FtMZ) ./ FtMZ;
dtLZ = 100*(NtLZ - FtLZ) ./ FtLZ;
dtMH = 100*(NtMH - FtMH) ./ FtMH;
dtLH = 100*(NtLH - FtLH) ./ FtLH;

dsDE = 100*(NsDE - FsDE) ./ FsDE;
dsMZ = 100*(NsMZ - FsMZ) ./ FsMZ;
dsLZ = 100*(NsLZ - FsLZ) ./ FsLZ;
dsMH = 100*(NsMH - FsMH) ./ FsMH;
dsLH = 100*(NsLH - FsLH) ./ FsLH;

dvMZ = 100*(NvMZ - FvMZ) ./ FvMZ;
dvLZ = 100*(NvLZ - FvLZ) ./ FvLZ;
dvMH = 100*(NvMH - FvMH) ./ FvMH;
dvLH = 100*(NvLH - FvLH) ./ FvLH;
...
xlabel('Months')
%stamp('')
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_ts_Pdiff_feisty_forcing.png'])
...
ylabel('Depth (m)')
%stamp('')
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_vert_Pdiff_feisty_forcing.png'])
...
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_map_Pdiff_MZ.png'])
...
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_map_Pdiff_LZ.png'])
...
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_map_mean_Pdiff_mzHPloss.png'])
...
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_map_mean_Pdiff_lzHPloss.png'])
...
stamp('')
print('-dpng',[ppath 'OM4_05_COBALTv3_FEISTY_on-off_map_mean_Pdiff_DetBtm.png'])
