...
%% 
load([fpath Yr '0101.ocean_feisty_tracers_z_means.mat'])
...
stamp(Yr)
print('-dpng',[ppath mod Yr '_ts_logmean_feisty_all_sizes_v2.png'])
...
ylabel('log10 Integrated Biomass (g m^-^2)')
stamp(Yr)
print('-dpng',[ppath mod Yr '_ts_logmean_feisty_all_types_v2.png'])
...
stamp(Yr)
print('-dpng',[ppath mod Yr '_ts_mean_feisty_all_sizes_v2.png'])
...
ylabel('Integrated Biomass (g m^-^2)')
stamp(Yr)
print('-dpng',[ppath mod Yr '_ts_mean_feisty_all_types_v2.png'])
...
ylabel('Depth (m)')
stamp(Yr)
print('-dpng',[ppath mod Yr '_vert_mean_feisty_subplot_v2.png'])
...
ylabel('Depth (m)')
stamp(Yr)
print('-dpng',[ppath mod Yr '_vert_upper_mean_feisty_subplot_v2.png'])
...
stamp(Yr)
print('-dpng',[ppath mod Yr '_global_Bent_v2.png'])
...
stamp(Yr)
print('-dpng',[ppath mod Yr '_global_All_subplot_v2.png'])
...
title('log10 mean All fishes (g m^-^2)')
stamp(Yr)
print('-dpng',[ppath mod Yr '_global_All_subplot_newcb_v2.png'])
...
stamp(Yr)
print('-dpng',[ppath mod Yr '_global_ratios_subplot_v2.png'])
