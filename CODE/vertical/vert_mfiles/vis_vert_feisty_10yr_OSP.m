% Look at COBALT-FEISTY offline vert 1D at OSP
...
fpath = ['/Volumes/petrik-lab/Feisty/NC/MOM6-1D/OSP_vert/offline_feisty/' cname '/'];

exper = 'OSP_10yr_COBALT2004_v4_HPcap_All_fish03';
...
load([vpath '20040101.ocean_grid_366_OSP.mat'],'zl','zl_long_name',...
    'zi')
