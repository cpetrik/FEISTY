...
exper = 'BATS_spinup_fromIC_COBALT2004_v2_HPcap_All_fish03';
...
tSDrec=mean(M_rec_SD,1);
tMDrec=sum(M_rec_MD,1);
tLDrec=sum(M_rec_LD,1);

tSDnu=mean(M_nu_SD,1);
tMDnu=sum(M_nu_MD,1);
tLDnu=sum(M_nu_LD,1);

tLDrep=sum(M_rep_LD,1);
...
figure(5)
subplot(3,3,1)
pcolor(tts(1:45,:),zl2(1:45,:),M_rec_SD(1:45,:));
shading flat;
colorbar
clim([0 1e-8])
title('SD rec')
...
subplot(3,3,2)
pcolor(tts(1:45,:),zl2(1:45,:),M_nu_SD(1:45,:));
shading flat;
colorbar
%clim([-5 0])
title('SD nu')
...
subplot(3,3,4)
pcolor(tts(73:75,:),zl2(73:75,:),M_rec_MD(74:76,:));
shading flat;
colorbar
title('MD rec')
%clim([-5 0])
...
subplot(3,3,5)
pcolor(tts(73:75,:),zl2(73:75,:),M_nu_MD(74:76,:));
shading flat;
colorbar
%clim([-5 0])
title('MD nu')
...
subplot(3,3,7)
pcolor(tts(73:75,:),zl2(73:75,:),M_rec_LD(74:76,:));
shading flat;
colorbar
%clim([-2 2])
title('LD rec')
...
subplot(3,3,8)
pcolor(tts(73:75,:),zl2(73:75,:),M_nu_LD(74:76,:));
shading flat;
colorbar
title('LD nu')
%clim([-5 0])
...
subplot(3,3,9)
pcolor(tts(73:75,:),zl2(73:75,:),M_rep_LD(74:76,:));
shading flat;
colorbar
%clim([-10 -5])
title('LD rep')
print('-dpng',[ppath exper '_depth_ts_demersals_zoom.png'])
...
figure(7)
subplot(3,3,1)
plot(y,tSDrec,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('SD rec')

subplot(3,3,2)
plot(y,tSDnu,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('SD nu')

subplot(3,3,3)
plot(y,tSD,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('SD bio')
...
subplot(3,3,4)
plot(y,tMDrec,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('MD rec')

subplot(3,3,5)
plot(y,tMDnu,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('MD nu')

subplot(3,3,6)
plot(y,tMD,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('MD bio')
...
subplot(3,3,7)
plot(y,tLDrec,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('LD rec')

subplot(3,3,8)
plot(y,tLDnu,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('LD nu')

subplot(3,3,9)
plot(y,tLDrep,'k','Linewidth',2); hold on;
xlim([y(1) y(end)])
%ylim([-5 2])
title('LD rep')
...
stamp('')
print('-dpng',[ppath exper '_ts_all_dems.png'])