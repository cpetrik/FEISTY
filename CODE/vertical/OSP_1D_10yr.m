...
%! Grids
vpath = '/Volumes/petrik-lab/Feisty/NC/MOM6-1D/OSP_vert/cobalt_only/';
%vpath = '/project/Feisty/NC/MOM6-1D/OSP_vert/cobalt_only/12mo/';

%1-D
load([vpath '20040101.ocean_grid_366_OSP.mat']);
...
exper = 'OSP_10yr_COBALT2004_v4';
opath = '/Volumes/petrik-lab/Feisty/NC/MOM6-1D/OSP_vert/offline_feisty/';
%opath = '/project/Feisty/NC/MOM6-1D/OSP_vert/offline_feisty/';
[fname,simname,sname] = sub_fname_spin(param,opath,exper);

%! Initialize
load([sname 'Last_mo_OSP_spinup_COBALT2004_v4_HPcap_All_fish03_' simname '.mat'])
[Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT] = sub_init_fish_multiyr(NID,Sml_f,Sml_p,Sml_d,Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT);
...
load([vpath,'20040101.ocean_cobalt_10yr_OSP.mat'],'mTP','mTB',...
    'mMZ','mMZhp','mLZ','mLZhp','mDbtm');

MNT=0;
for YR = 1:YEARS % years
    num2str(YR)

    yid = (((YR-1)*366)+1):(YR*366);
