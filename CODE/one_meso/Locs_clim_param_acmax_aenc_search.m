...
for k=1:length(acp)
    for j=1:length(aep)   
        ...
        fname = sub_fname_clim_locs_1meso(param);
        ...
        Spinup_Cobalt = NaN*ones(DAYS,4,NX);
        ...
        S_Cobalt = NaN*ones(12*YEARS,4,NX);
        ...
        for YR = 1:YEARS % years
            ...
            Med_f,Med_p,Med_d,Lrg_p,Lrg_d,BENT,param);
                ...
                Spinup_Cobalt(DY,:,:) = [BENT.mass BENT.pred ENVR.fZl,ENVR.fZb]';
