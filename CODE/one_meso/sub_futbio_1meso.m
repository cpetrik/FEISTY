...
function [Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,ENVR] = sub_futbio_1meso(ID,DY,COBALT,GRD,Sf,Sp,Sd,Mf,Mp,Md,Lp,Ld,BENT,param)
...
%%% COBALT information
ENVR = get_COBALT_1meso(COBALT,GRD,ID,DY);
...
Md.con_be = sub_cons(param,ENVR.Tp,ENVR.Tb,Md.td,param.M_m,(3/2)*Md.enc_be);
...
Ld.con_be = sub_cons(param,ENVR.Tp,ENVR.Tb,Ld.td,param.M_l,[(3/2)*Ld.enc_be,Ld.enc_f,Ld.enc_p,Ld.enc_d]);
...
[ENVR.fZl,ENVR.fZb] = ...
    sub_hploss_zm(Sf.con_zm,Sp.con_zm,Sd.con_zm,Mf.con_zm,Mp.con_zm,...
    Sf.bio,Sp.bio,Sd.bio,Mf.bio,Mp.bio,ENVR.dZm,ENVR.Zm);
