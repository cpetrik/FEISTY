...
% with COBALT overconsump from HPloss vs. empirical fn of biom & temp
...
load([fpath2 'Means_Historic_1meso_empHPloss_',harv,'_' cfile2 '.mat'],...
    'sf_mean50','sp_mean50','sd_mean50',...
    'mf_mean50','mp_mean50','md_mean50',...
    'lp_mean50','ld_mean50','b_mean50','Fish1meso');
load([fpath2 'Hist_1meso_empHPloss_' harv '_ts_map_zoop_overcon.mat'],...
    'CFmz','COmz');
...
set(gcf,'renderer','painters')
title('HPloss F');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_F.png'])
...
set(gcf,'renderer','painters')
title('HPloss P');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_P.png'])
...
set(gcf,'renderer','painters')
title('HPloss D');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_D.png'])
...
set(gcf,'renderer','painters')
title('HPloss All');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_All.png'])
...
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_Bent.png'])
...
colorbar
set(gcf,'renderer','painters')
title('emp HPloss Mean frac Zhploss con')
...
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_zoop_fraccon.png'])
...
colorbar
set(gcf,'renderer','painters')
title('emp HPloss Mean times Zhploss overcon')
...
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_zoop_overcon.png'])
...
set(gcf,'renderer','painters')
title('HPloss P/(P+D)');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_PD.png'])
...
set(gcf,'renderer','painters')
title('HPloss P/(P+F)');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_PF.png'])
...
set(gcf,'renderer','painters')
title('HPloss L/(L+M)');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_LM.png'])
...
colorbar
set(gcf,'renderer','painters')
title('All HPloss - emp HPloss');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_pdiff_fish.png'])
...
colorbar
set(gcf,'renderer','painters')
title('B HPloss - emp HPloss');
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_pdiff_fracs.png'])
...
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_global_diff_MZcon.png'])
...
xlim([1865 2005])
ylim([-0.5 1])
print('-dpng',[pp 'Meso1_empHPloss_HPloss_noHP_' harv '_ts_stages.png'])
