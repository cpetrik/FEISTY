...
% SP
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_sml_p.nc'],'NC_NOWRITE');
...
% SF
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_sml_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% SD
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_sml_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MP
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_med_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MF
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_med_f.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% MD
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_med_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LP
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_lrg_p.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% LD
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_lrg_d.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
% Benthic material
ncid = netcdf.open([fpath 'Historic_1meso_empHPloss_' harv '_bent.nc'],'NC_NOWRITE');
[ndims,nvars,ngatts,unlimdimid] = netcdf.inq(ncid);
for i = 1:nvars
    varname = netcdf.inqVar(ncid, i-1);
    eval([ varname ' = netcdf.getVar(ncid,i-1);']);
...
%%
save([fpath 'Means_Historic_1meso_empHPloss_' harv '_' cfile '.mat'],'time','y','yr50','yr1','lyr',...
...
%save([fpath 'Means_Historic_1meso_empHPloss_' harv '_' cfile '.mat']);


% Save last year for initializing forecast runs
save([fpath 'Last_mo_hist_1meso_empHPloss_' harv '_' cfile '.mat'],'Sml_f','Sml_p','Sml_d',... 
