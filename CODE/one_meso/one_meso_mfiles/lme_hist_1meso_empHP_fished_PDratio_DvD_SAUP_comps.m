...
load([dpath 'LME_Hist_1meso_empHPloss_',harv,'_' cfile '.mat']);
...
writetable(Fstat,[dpath 'Hist_1meso_empHPloss_LME_DvD_SAU_stats_' cfile '.csv'],'Delimiter',',','WriteRowNames',true)
save([dpath 'Hist_1meso_empHPloss_LME_DvD_SAU_stats_' cfile '.mat'],'fish_stat')
...
%title('Fraction Large Pelagics')
%stamp(cfile)
print('-dpng',[ppath 'Hist_1meso_empHPloss_' harv '_LME_fracPD_catch_SAUP_DvD_comp_subplot.png'])
