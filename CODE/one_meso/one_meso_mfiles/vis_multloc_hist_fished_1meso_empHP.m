...
load([fpath 'Means_Historic_1meso_empHPloss_',harv,'_' cfile '.mat']);
...
Fish1meso(1,:)=sf_tmean;
Fish1meso(2,:)=sp_tmean;
Fish1meso(3,:)=sd_tmean;
Fish1meso(4,:)=mf_tmean;
Fish1meso(5,:)=mp_tmean;
Fish1meso(6,:)=md_tmean;
Fish1meso(7,:)=lp_tmean;
Fish1meso(8,:)=ld_tmean;
Fish1meso(9,:)=b_tmean;
save([fpath 'Means_Historic_1meso_empHPloss_',harv,'_' cfile '.mat'],'Fish1meso','-append');
...
stamp(cfile)
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_all_sizes.png'])
...
ylabel('log10 Biomass (g m^-^2)')
title(['Historic fished'])
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_all_types.png'])
...
title('Historic fished')
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_ts_mbio.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_global_BENT.png'])
...
%stamp(cfile)
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_global_All_subplot.png'])
...
stamp(cfile)
print('-dpng',[ppath 'Hist_1meso_empHPloss_',harv,'_global_ratios_subplot.png'])
...
text(-2.75,1.25,'D')
%     stamp([harv '_' cfile])
print('-dpng',[ppath 'Hist_1meso_empHPloss_' harv '_global_fish_4plot_BP.png'])
